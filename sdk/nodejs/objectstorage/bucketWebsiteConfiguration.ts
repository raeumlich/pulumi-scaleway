 ...
 *
 * const mainBucket = new scaleway.objectstorage.Bucket("mainBucket", {acl: "public-read"});
 * const mainBucketWebsiteConfiguration = new scaleway.objectstorage.BucketWebsiteConfiguration("mainBucketWebsiteConfiguration", {
 ...
 *
 * const mainBucket = new scaleway.objectstorage.Bucket("mainBucket", {acl: "public-read"});
 * const mainBucketPolicy = new scaleway.objectstorage.BucketPolicy("mainBucketPolicy", {
 *     bucket: mainBucket.id,
...
export class BucketWebsiteConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:objectstorage/bucketWebsiteConfiguration:BucketWebsiteConfiguration';
     ...
     */
    public readonly errorDocument!: pulumi.Output<outputs.objectstorage.BucketWebsiteConfigurationErrorDocument | undefined>;
    /**
     * The name of the index document for the website detailed below.
     */
    public readonly indexDocument!: pulumi.Output<outputs.objectstorage.BucketWebsiteConfigurationIndexDocument>;
    /**
...
export interface BucketWebsiteConfigurationState {
     ...
     * The name of the error document for the website detailed below.
     */
    errorDocument?: pulumi.Input<inputs.objectstorage.BucketWebsiteConfigurationErrorDocument>;
    /**
     * The name of the index document for the website detailed below.
     */
    indexDocument?: pulumi.Input<inputs.objectstorage.BucketWebsiteConfigurationIndexDocument>;
    /**
     * The project_id you want to attach the resource to
     */

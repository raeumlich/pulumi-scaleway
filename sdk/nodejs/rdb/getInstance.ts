...
export function getInstance(args?: GetInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceResult> {
    ...
    return pulumi.runtime.invoke("scaleway:rdb/getInstance:getInstance", {
...
export interface GetInstanceResult {
    ...
    readonly loadBalancers: outputs.rdb.GetInstanceLoadBalancer[];
    readonly name?: string;
    readonly nodeType: string;
    readonly organizationId: string;
    readonly password: string;
    readonly privateNetworks: outputs.rdb.GetInstancePrivateNetwork[];
    readonly projectId?: string;
    readonly readReplicas: outputs.rdb.GetInstanceReadReplica[];

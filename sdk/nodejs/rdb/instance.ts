...
export class Instance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:rdb/instance:Instance';
     ...
     */
    public readonly loadBalancers!: pulumi.Output<outputs.rdb.InstanceLoadBalancer[]>;
    /**
     ...
     */
    public readonly privateNetwork!: pulumi.Output<outputs.rdb.InstancePrivateNetwork | undefined>;
    /**
     ...
     */
    public /*out*/ readonly readReplicas!: pulumi.Output<outputs.rdb.InstanceReadReplica[]>;
    /**
     * `region`) The region
...
export interface InstanceState {
     ...
     * This block must be defined if you want a public endpoint in addition to your private endpoint.
     */
    loadBalancers?: pulumi.Input<pulumi.Input<inputs.rdb.InstanceLoadBalancer>[]>;
    /**
     * The name of the Database Instance.
     */
     ...
     * List of private networks endpoints of the database instance.
     */
    privateNetwork?: pulumi.Input<inputs.rdb.InstancePrivateNetwork>;
    /**
     * `projectId`) The ID of the project the Database
     * Instance is associated with.
     */
     ...
     * List of read replicas of the database instance.
     */
    readReplicas?: pulumi.Input<pulumi.Input<inputs.rdb.InstanceReadReplica>[]>;
    /**
     * `region`) The region
     * in which the Database Instance should be created.
     */

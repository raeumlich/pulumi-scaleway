 ...
 *
 * const findByName = scaleway.rdb.getDatabaseBackup({
 *     name: "mybackup",
 * });
 * const findByNameAndInstance = scaleway.rdb.getDatabaseBackup({
 *     instanceId: "11111111-1111-1111-1111-111111111111",
 *     name: "mybackup",
 * });
 * const findById = scaleway.rdb.getDatabaseBackup({
...
export function getDatabaseBackup(args?: GetDatabaseBackupArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseBackupResult> {
    ...
    return pulumi.runtime.invoke("scaleway:rdb/getDatabaseBackup:getDatabaseBackup", {

 ...
 * const mainUserData = new scaleway.instance.UserData("mainUserData", {
 ...
 *     data.push(new scaleway.instance.UserData(`data-${range.value}`, {
 *         serverId: mainServer.id,
 *         key: range.key,
 *         value: range.value,
 *     }));
...
export class UserData extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:instance/userData:UserData';
    ...
    constructor(name: string, argsOrState?: UserDataArgs | UserDataState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserData.__pulumiType, name, resourceInputs, opts);
    }
}

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "scaleway:secret/secret:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "scaleway:secret/version:Version":
...
pulumi.runtime.registerResourceModule("scaleway", "secret/secret", _module)
pulumi.runtime.registerResourceModule("scaleway", "secret/version", _module)

 ...
 *     vpcId: vpc01.id,
 * });
 * const pg01 = new scaleway.vpc.PublicGateway("pg01", {type: "VPC-GW-S"});
 * const main = new scaleway.vpc.GatewayNetwork("main", {
 *     gatewayId: pg01.id,
 ...
 *
 * const pn01 = new scaleway.vpc.PrivateNetwork("pn01", {});
 * const gw01 = new scaleway.vpc.PublicGatewayIP("gw01", {});
 * const dhcp01 = new scaleway.vpc.PublicGatewayDHCP("dhcp01", {
...
export class GatewayNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:vpc/gatewayNetwork:GatewayNetwork';
     ...
     */
    public readonly ipamConfigs!: pulumi.Output<outputs.vpc.GatewayNetworkIpamConfig[]>;
    /**
...
export interface GatewayNetworkState {
     ...
     * Auto-configure the Gateway Network using Scaleway's IPAM (IP address management service). Only one of `dhcpId`, `staticAddress` and `ipamConfig` should be specified.
     */
    ipamConfigs?: pulumi.Input<pulumi.Input<inputs.vpc.GatewayNetworkIpamConfig>[]>;
    /**
     * The mac address of the creation of the gateway network.
     */

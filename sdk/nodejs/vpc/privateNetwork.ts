 ...
 *
 * const pnPriv = new scaleway.vpc.PrivateNetwork("pnPriv", {tags: [
 *     "demo",
 *     "terraform",
 * ]});
 * ```
 ...
 * import * as scaleway from "@pulumi/scaleway";
 *
 * const pnPriv = new scaleway.vpc.PrivateNetwork("pnPriv", {
 *     ipv4Subnet: {
...
export class PrivateNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:vpc/privateNetwork:PrivateNetwork';
     ...
     */
    public readonly ipv4Subnet!: pulumi.Output<outputs.vpc.PrivateNetworkIpv4Subnet>;
    /**
     * The IPv6 subnets to associate with the private network.
     */
    public readonly ipv6Subnets!: pulumi.Output<outputs.vpc.PrivateNetworkIpv6Subnet[]>;
    /**
...
export interface PrivateNetworkState {
     ...
     * The IPv4 subnet to associate with the private network.
     */
    ipv4Subnet?: pulumi.Input<inputs.vpc.PrivateNetworkIpv4Subnet>;
    /**
     * The IPv6 subnets to associate with the private network.
     */
    ipv6Subnets?: pulumi.Input<pulumi.Input<inputs.vpc.PrivateNetworkIpv6Subnet>[]>;
    /**
     * The private networks are necessarily regional now.
     *
     * @deprecated This field is deprecated and will be removed in the next major version

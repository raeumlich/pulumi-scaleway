 ...
 * });
 * const byId = scaleway.vpc.getGatewayNetworkOutput({
 *     gatewayNetworkId: main.id,
 * });
 * const byGatewayAndPn = scaleway.vpc.getGatewayNetwork({
 *     gatewayId: scaleway_vpc_public_gateway.pg01.id,
 *     privateNetworkId: scaleway_vpc_private_network.pn01.id,
 * });
 * ```
...
export function getGatewayNetwork(args?: GetGatewayNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayNetworkResult> {
    ...
    return pulumi.runtime.invoke("scaleway:vpc/getGatewayNetwork:getGatewayNetwork", {
        "dhcpId": args.dhcpId,
...
export interface GetGatewayNetworkResult {
     ...
     */
    readonly id: string;
    readonly ipamConfigs: outputs.vpc.GetGatewayNetworkIpamConfig[];

 ...
 *     zone: "nl-ams-1",
 * });
 * const pgTestByName = scaleway.vpc.getPublicGatewayOutput({
 *     name: main.name,
 *     zone: "nl-ams-1",
 * });
 * const pgTestById = scaleway.vpc.getPublicGatewayOutput({
...
export function getPublicGateway(args?: GetPublicGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicGatewayResult> {
    ...
    return pulumi.runtime.invoke("scaleway:vpc/getPublicGateway:getPublicGateway", {
        "name": args.name,
 ...
 */
export interface GetPublicGatewayArgs {
    /**
 ...
 * A collection of arguments for invoking getPublicGateway.
 */
export interface GetPublicGatewayOutputArgs {
    /**
     * Exact name of the public gateway.
     */

 ...
 *
 * const main = scaleway.cockpit.getCockpit({});
 * ```
...
export function getCockpit(args?: GetCockpitArgs, opts?: pulumi.InvokeOptions): Promise<GetCockpitResult> {
    ...
    return pulumi.runtime.invoke("scaleway:cockpit/getCockpit:getCockpit", {
...
export interface GetCockpitResult {
     ...
     * Endpoints
     */
    readonly endpoints: outputs.cockpit.GetCockpitEndpoint[];
    /**
    ...
    readonly pushUrls: outputs.cockpit.GetCockpitPushUrl[];
}
/**
 * Gets information about the Scaleway Cockpit.
 *

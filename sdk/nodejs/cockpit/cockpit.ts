...
export class Cockpit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:cockpit/cockpit:Cockpit';
     ...
     * Endpoints.
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.cockpit.CockpitEndpoint[]>;
    /**
...
export interface CockpitState {
     ...
     * Endpoints.
     */
    endpoints?: pulumi.Input<pulumi.Input<inputs.cockpit.CockpitEndpoint>[]>;
    /**
     * Name or ID of the plan to use.
     */

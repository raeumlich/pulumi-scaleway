 ...
 *
 * const byName = scaleway.loadbalancer.getLoadBalancer({
 *     name: "foobar",
 * });
 * const byId = scaleway.loadbalancer.getLoadBalancer({
...
export function getLoadBalancer(args?: GetLoadBalancerArgs, opts?: pulumi.InvokeOptions): Promise<GetLoadBalancerResult> {
    ...
    return pulumi.runtime.invoke("scaleway:loadbalancer/getLoadBalancer:getLoadBalancer", {
        "lbId": args.lbId,
        "name": args.name,
...
export interface GetLoadBalancerResult {
    ...
    readonly privateNetworks: outputs.loadbalancer.GetLoadBalancerPrivateNetwork[];

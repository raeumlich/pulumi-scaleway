 ...
 *
 * const backend01 = new scaleway.loadbalancer.Backend("backend01", {
...
export class Backend extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:loadbalancer/backend:Backend';
     ...
     */
    public readonly healthCheckHttp!: pulumi.Output<outputs.loadbalancer.BackendHealthCheckHttp | undefined>;
    /**
     * This block enable HTTPS health check. Only one of `healthCheckTcp`, `healthCheckHttp` and `healthCheckHttps` should be specified.
     */
    public readonly healthCheckHttps!: pulumi.Output<outputs.loadbalancer.BackendHealthCheckHttps | undefined>;
    /**
     ...
     */
    public readonly healthCheckTcp!: pulumi.Output<outputs.loadbalancer.BackendHealthCheckTcp>;
    /**
...
export interface BackendState {
     ...
     * This block enable HTTP health check. Only one of `healthCheckTcp`, `healthCheckHttp` and `healthCheckHttps` should be specified.
     */
    healthCheckHttp?: pulumi.Input<inputs.loadbalancer.BackendHealthCheckHttp>;
    /**
     * This block enable HTTPS health check. Only one of `healthCheckTcp`, `healthCheckHttp` and `healthCheckHttps` should be specified.
     */
    healthCheckHttps?: pulumi.Input<inputs.loadbalancer.BackendHealthCheckHttps>;
    /**
     * Number of allowed failed HC requests before the backend server is marked down.
     */
     ...
     * This block enable TCP health check. Only one of `healthCheckTcp`, `healthCheckHttp` and `healthCheckHttps` should be specified.
     */
    healthCheckTcp?: pulumi.Input<inputs.loadbalancer.BackendHealthCheckTcp>;
    /**
     * Timeout before we consider a HC request failed.
     */

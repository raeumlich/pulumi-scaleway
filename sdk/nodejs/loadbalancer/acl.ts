 ...
 *
 * const acl01 = new scaleway.loadbalancer.ACL("acl01", {
...
export class ACL extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:loadbalancer/aCL:ACL';
     ...
     */
    public readonly action!: pulumi.Output<outputs.loadbalancer.ACLAction>;
    /**
     ...
     */
    public readonly match!: pulumi.Output<outputs.loadbalancer.ACLMatch | undefined>;
    /**
...
export interface ACLState {
     ...
     * Action to undertake when an ACL filter matches.
     */
    action?: pulumi.Input<inputs.loadbalancer.ACLAction>;
    /**
     * Date and time of ACL's creation (RFC 3339 format)
     */
     ...
     * The ACL match rule. At least `ipSubnet` or `httpFilter` and `httpFilterValue` are required.
     */
    match?: pulumi.Input<inputs.loadbalancer.ACLMatch>;
    /**
     * The ACL name. If not provided it will be randomly generated.
     */

 ...
 *
 * const frontend01 = new scaleway.loadbalancer.Frontend("frontend01", {
...
export class Frontend extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:loadbalancer/frontend:Frontend';
     ...
     */
    public readonly acls!: pulumi.Output<outputs.loadbalancer.FrontendAcl[] | undefined>;
    /**
...
export interface FrontendState {
     ...
     * A list of ACL rules to apply to the load-balancer frontend.  Defined below.
     */
    acls?: pulumi.Input<pulumi.Input<inputs.loadbalancer.FrontendAcl>[]>;
    /**
     * The load-balancer backend ID this frontend is attached to.
     *
     * > **Important:** Updates to `lbId` or `backendId` will recreate the frontend.

 ...
 *
 * const main = new scaleway.serverless.FunctionTrigger("main", {
...
export class FunctionTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:serverless/functionTrigger:FunctionTrigger';
     ...
     */
    public readonly nats!: pulumi.Output<outputs.serverless.FunctionTriggerNats | undefined>;
    /**
     ...
     */
    public readonly sqs!: pulumi.Output<outputs.serverless.FunctionTriggerSqs | undefined>;
...
export interface FunctionTriggerState {
     ...
     * The configuration for the Scaleway's Nats used by the trigger
     */
    nats?: pulumi.Input<inputs.serverless.FunctionTriggerNats>;
    /**
     * `region`). The region in which the namespace should be created.
     */
     ...
     * The configuration of the Scaleway's SQS used by the trigger
     */
    sqs?: pulumi.Input<inputs.serverless.FunctionTriggerSqs>;
}

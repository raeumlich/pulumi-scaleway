 ...
 *
 * const byName = scaleway.serverless.getContainerNamespace({
 *     name: "my-namespace-name",
 * });
 * const byId = scaleway.serverless.getContainerNamespace({
...
export function getContainerNamespace(args?: GetContainerNamespaceArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerNamespaceResult> {
    ...
    return pulumi.runtime.invoke("scaleway:serverless/getContainerNamespace:getContainerNamespace", {
        "name": args.name,

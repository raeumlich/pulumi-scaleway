 ...
 *     deploy: true,
 * });
 * const mainFunctionDomain = new scaleway.serverless.FunctionDomain("mainFunctionDomain", {
...
export class FunctionDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:serverless/functionDomain:FunctionDomain';

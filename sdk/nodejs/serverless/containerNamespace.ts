 ...
 *
 * const main = new scaleway.serverless.ContainerNamespace("main", {description: "Main container namespace"});
 * ```
 *
 * ## Import
 *
...
export class ContainerNamespace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:serverless/containerNamespace:ContainerNamespace';

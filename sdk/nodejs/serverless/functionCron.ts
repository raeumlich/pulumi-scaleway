 ...
 * });
 * const mainFunctionCron = new scaleway.serverless.FunctionCron("mainFunctionCron", {
 ...
 *     }),
 * });
 * const func = new scaleway.serverless.FunctionCron("func", {
 *     functionId: mainFunction.id,
 *     schedule: "0 1 * * *",
 *     args: JSON.stringify({
 *         my_var: "terraform",
...
export class FunctionCron extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:serverless/functionCron:FunctionCron';

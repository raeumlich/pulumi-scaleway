 ...
 * const mainContainerCron = new scaleway.serverless.ContainerCron("mainContainerCron", {
...
export class ContainerCron extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:serverless/containerCron:ContainerCron';

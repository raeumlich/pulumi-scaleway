 ...
 *
 * const main = new scaleway.serverless.ContainerTrigger("main", {
...
export class ContainerTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:serverless/containerTrigger:ContainerTrigger';
     ...
     */
    public readonly nats!: pulumi.Output<outputs.serverless.ContainerTriggerNats | undefined>;
    /**
     ...
     */
    public readonly sqs!: pulumi.Output<outputs.serverless.ContainerTriggerSqs | undefined>;
...
export interface ContainerTriggerState {
     ...
     * The configuration for the Scaleway's Nats used by the trigger
     */
    nats?: pulumi.Input<inputs.serverless.ContainerTriggerNats>;
    /**
     * `region`). The region in which the namespace should be created.
     */
     ...
     * The configuration of the Scaleway's SQS used by the trigger
     */
    sqs?: pulumi.Input<inputs.serverless.ContainerTriggerSqs>;
}

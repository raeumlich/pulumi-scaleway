 ...
 * const byName = scaleway.serverless.getContainerOutput({
 *     namespaceId: mainContainerNamespace.id,
 *     name: mainContainer.name,
 * });
 * const byId = scaleway.serverless.getContainerOutput({
 *     namespaceId: mainContainerNamespace.id,
...
export function getContainer(args: GetContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerResult> {
    ...
    return pulumi.runtime.invoke("scaleway:serverless/getContainer:getContainer", {

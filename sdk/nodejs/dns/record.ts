 ...
 *
 * const www = new scaleway.dns.Record("www", {
 *     data: "1.2.3.4",
 *     dnsZone: "domain.tld",
 *     ttl: 3600,
 *     type: "A",
 * });
 * const www2 = new scaleway.dns.Record("www2", {
 *     data: "1.2.3.5",
 *     dnsZone: "domain.tld",
 *     ttl: 3600,
 *     type: "A",
 * });
 * const mx = new scaleway.dns.Record("mx", {
 *     data: "mx.online.net.",
 *     dnsZone: "domain.tld",
 *     priority: 10,
 *     ttl: 3600,
 *     type: "MX",
 * });
 * const mx2 = new scaleway.dns.Record("mx2", {
 ...
 * import * as scaleway from "@pulumi/scaleway";
 *
 * const geoIp = new scaleway.dns.Record("geoIp", {
 *     data: "1.2.3.4",
 *     dnsZone: "domain.tld",
 *     geoIp: {
 *         matches: [
 ...
 *     type: "A",
 * });
 * const httpService = new scaleway.dns.Record("httpService", {
 *     data: "1.2.3.4",
 *     dnsZone: "domain.tld",
 *     httpService: {
 *         ips: [
 ...
 *     type: "A",
 * });
 * const view = new scaleway.dns.Record("view", {
 *     data: "1.2.3.4",
 *     dnsZone: "domain.tld",
 *     ttl: 3600,
 *     type: "A",
 ...
 *     ],
 * });
 * const weighted = new scaleway.dns.Record("weighted", {
 *     data: "1.2.3.4",
 *     dnsZone: "domain.tld",
 *     ttl: 3600,
 *     type: "A",
 ...
 * const publicIp = new scaleway.instance.IP("publicIp", {projectId: projectId});
 ...
 *     },
 * });
 * const webA = new scaleway.dns.Record("webA", {
 *     dnsZone: dnsZone,
 *     type: "A",
 *     data: web.publicIp,
 *     ttl: 3600,
 * });
 * const webCname = new scaleway.dns.Record("webCname", {
 *     dnsZone: dnsZone,
 *     type: "CNAME",
 *     data: `web.${dnsZone}.`,
 *     ttl: 3600,
 * });
 * const webAlias = new scaleway.dns.Record("webAlias", {
 *     dnsZone: dnsZone,
 *     type: "ALIAS",
 *     data: `web.${dnsZone}.`,
 *     ttl: 3600,
...
export class Record extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:dns/record:Record';
     ...
     */
    public readonly geoIp!: pulumi.Output<outputs.dns.RecordGeoIp | undefined>;
    /**
     ...
     */
    public readonly httpService!: pulumi.Output<outputs.dns.RecordHttpService | undefined>;
    /**
     ...
     */
    public readonly views!: pulumi.Output<outputs.dns.RecordView[] | undefined>;
    /**
     ...
     */
    public readonly weighteds!: pulumi.Output<outputs.dns.RecordWeighted[] | undefined>;
...
export interface RecordState {
     ...
     * The Geo IP feature provides DNS resolution, based on the user’s geographical location. You can define a default IP that resolves if no Geo IP rule matches, and specify IPs for each geographical zone. [Documentation and usage example](https://www.scaleway.com/en/docs/network/domains-and-dns/how-to/manage-dns-records/#geo-ip-records)
     */
    geoIp?: pulumi.Input<inputs.dns.RecordGeoIp>;
    /**
     * The DNS service checks the provided URL on the configured IPs and resolves the request to one of the IPs by excluding the ones not responding to the given string to check. [Documentation and usage example](https://www.scaleway.com/en/docs/network/domains-and-dns/how-to/manage-dns-records/#healthcheck-records)
     */
    httpService?: pulumi.Input<inputs.dns.RecordHttpService>;
    /**
     * When destroying a resource, if only NS records remain and this is set to `false`, the zone will be deleted. Please note, each zone not deleted will [cost you money](https://www.scaleway.com/en/dns/)
     */
     ...
     * The answer to a DNS request is based on the client’s (resolver) subnet. *(Can be more than 1)* [Documentation and usage example](https://www.scaleway.com/en/docs/network/domains-and-dns/how-to/manage-dns-records/#views-records)
     */
    views?: pulumi.Input<pulumi.Input<inputs.dns.RecordView>[]>;
    /**
     * You provide a list of IPs with their corresponding weights. These weights are used to proportionally direct requests to each IP. Depending on the weight of a record more or fewer requests are answered with its related IP compared to the others in the list. *(Can be more than 1)* [Documentation and usage example](https://www.scaleway.com/en/docs/network/domains-and-dns/how-to/manage-dns-records/#weight-records)
     */
    weighteds?: pulumi.Input<pulumi.Input<inputs.dns.RecordWeighted>[]>;
}

 ...
 *     name: "lite",
 * });
 * const main = new scaleway.webhosting.WebHosting("main", {
...
export class WebHosting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:webhosting/webHosting:WebHosting';
     ...
     */
    public /*out*/ readonly cpanelUrls!: pulumi.Output<outputs.webhosting.WebHostingCpanelUrl[]>;
    /**
     ...
     */
    public /*out*/ readonly options!: pulumi.Output<outputs.webhosting.WebHostingOption[]>;
    /**
...
export interface WebHostingState {
     ...
     * The URL to connect to cPanel Dashboard and to Webmail interface.
     */
    cpanelUrls?: pulumi.Input<pulumi.Input<inputs.webhosting.WebHostingCpanelUrl>[]>;
    /**
     * Date and time of hosting's creation (RFC 3339 format).
     */
     ...
     * The active options of the hosting.
     */
    options?: pulumi.Input<pulumi.Input<inputs.webhosting.WebHostingOption>[]>;
    /**
     * The organization ID the hosting is associated with.
     */

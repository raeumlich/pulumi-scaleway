 ...
 *
 * const byDomain = scaleway.webhosting.getWebHosting({
 *     domain: "foobar.com",
 * });
 * const byId = scaleway.webhosting.getWebHosting({
...
export function getWebHosting(args?: GetWebHostingArgs, opts?: pulumi.InvokeOptions): Promise<GetWebHostingResult> {
    ...
    return pulumi.runtime.invoke("scaleway:webhosting/getWebHosting:getWebHosting", {
        "domain": args.domain,
...
export interface GetWebHostingResult {
    readonly cpanelUrls: outputs.webhosting.GetWebHostingCpanelUrl[];
    ...
    readonly options: outputs.webhosting.GetWebHostingOption[];

...
export namespace dns {
    ...
    export interface RecordGeoIp {
         ...
         */
        matches: outputs.dns.RecordGeoIpMatch[];
    }
...
export namespace elasticmetal {
    ...
    export interface GetFlexibleIPsIp {
         ...
         */
        macAddresses: outputs.elasticmetal.GetFlexibleIPsIpMacAddress[];
        /**
...
export namespace loadbalancer {
    export interface ACLAction {
         ...
         */
        redirects?: outputs.loadbalancer.ACLActionRedirect[];
        /**
    ...
    export interface CertficateCustomCertificate {
        /**
    ...
    export interface CertficateLetsencrypt {
        /**
    ...
    export interface FrontendAcl {
         ...
         */
        match: outputs.loadbalancer.FrontendAclMatch;
        /**
    ...
    export interface FrontendAclAction {
         ...
         * Redirect parameters when using an ACL with `redirect` action.
         */
        redirects?: outputs.loadbalancer.FrontendAclActionRedirect[];
        /**
         * The redirect type. Possible values are: `location` or `scheme`.
         */
        type: string;
    ...
    export interface GetACLsAcl {
         ...
         */
        actions: outputs.loadbalancer.GetACLsAclAction[];
        /**
         ...
         * The ACL match rule.
         */
        matches: outputs.loadbalancer.GetACLsAclMatch[];
        /**
    ...
    export interface GetACLsAclAction {
         ...
         * Redirect parameters when using an ACL with `redirect` action.
         */
        redirects: outputs.loadbalancer.GetACLsAclActionRedirect[];
        /**
         * The redirect type.
         */
        type: string;
    ...
    export interface GetBackendsBackend {
         ...
         */
        healthCheckHttp: outputs.loadbalancer.GetBackendsBackendHealthCheckHttp[];
        /**
         * This block enable HTTPS health check.
         */
        healthCheckHttps: outputs.loadbalancer.GetBackendsBackendHealthCheckHttp[];
        /**
         ...
         */
        healthCheckTcps: outputs.loadbalancer.GetBackendsBackendHealthCheckTcp[];
        /**
    ...
    export interface GetLoadBalancersLb {
         ...
         */
        instances: outputs.loadbalancer.GetLoadBalancersLbInstance[];
        /**
         * List of IPs attached to the Load balancer.
         */
        ips: outputs.loadbalancer.GetLoadBalancersLbIp[];
        /**
...
export namespace objectstorage {
    ...
    export interface BucketLifecycleRule {
         ...
         */
        expiration?: outputs.objectstorage.BucketLifecycleRuleExpiration;
        /**
         ...
         */
        transitions?: outputs.objectstorage.BucketLifecycleRuleTransition[];
    }
    ...
    export interface BucketLockConfigurationRule {
         ...
         */
        defaultRetention: outputs.objectstorage.BucketLockConfigurationRuleDefaultRetention;
    }

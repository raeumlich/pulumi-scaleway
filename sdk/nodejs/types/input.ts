...
export namespace dns {
    export interface RecordGeoIp {
         ...
         */
        matches: pulumi.Input<pulumi.Input<inputs.dns.RecordGeoIpMatch>[]>;
    }
...
export namespace loadbalancer {
    export interface ACLAction {
         ...
         */
        redirects?: pulumi.Input<pulumi.Input<inputs.loadbalancer.ACLActionRedirect>[]>;
        /**
    ...
    export interface FrontendAcl {
         ...
         */
        action: pulumi.Input<inputs.loadbalancer.FrontendAclAction>;
        createdAt?: pulumi.Input<string>;
        description?: pulumi.Input<string>;
        /**
         * The ACL match rule. At least `ipSubnet` or `httpFilter` and `httpFilterValue` are required.
         */
        match: pulumi.Input<inputs.loadbalancer.FrontendAclMatch>;
        /**
    ...
    export interface FrontendAclAction {
         ...
         * Redirect parameters when using an ACL with `redirect` action.
         */
        redirects?: pulumi.Input<pulumi.Input<inputs.loadbalancer.FrontendAclActionRedirect>[]>;
        /**
         * The redirect type. Possible values are: `location` or `scheme`.
         */
        type: pulumi.Input<string>;
...
export namespace objectstorage {
    export interface BucketACLAccessControlPolicy {
        grants?: pulumi.Input<pulumi.Input<inputs.objectstorage.BucketACLAccessControlPolicyGrant>[]>;
        owner: pulumi.Input<inputs.objectstorage.BucketACLAccessControlPolicyOwner>;
    }

    export interface BucketACLAccessControlPolicyGrant {
        grantee?: pulumi.Input<inputs.objectstorage.BucketACLAccessControlPolicyGrantGrantee>;
    ...
    export interface BucketLifecycleRule {
         ...
         */
        expiration?: pulumi.Input<inputs.objectstorage.BucketLifecycleRuleExpiration>;
        /**
         ...
         */
        transitions?: pulumi.Input<pulumi.Input<inputs.objectstorage.BucketLifecycleRuleTransition>[]>;
    }
    ...
    export interface BucketLockConfigurationRule {
         ...
         */
        defaultRetention: pulumi.Input<inputs.objectstorage.BucketLockConfigurationRuleDefaultRetention>;
    }

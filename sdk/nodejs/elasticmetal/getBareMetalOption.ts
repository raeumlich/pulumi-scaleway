 ...
 *
 * const byName = scaleway.elasticmetal.getBareMetalOption({
 *     name: "Remote Access",
 * });
 * const byId = scaleway.elasticmetal.getBareMetalOption({
...
export function getBareMetalOption(args?: GetBareMetalOptionArgs, opts?: pulumi.InvokeOptions): Promise<GetBareMetalOptionResult> {
    ...
    return pulumi.runtime.invoke("scaleway:elasticmetal/getBareMetalOption:getBareMetalOption", {
        "name": args.name,

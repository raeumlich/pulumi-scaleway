 ...
 *
 * const main = scaleway.account.getSSHKey({
 *     name: "main",
 * });
...
export class BareMetalServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:elasticmetal/bareMetalServer:BareMetalServer';
     ...
     */
    public /*out*/ readonly ips!: pulumi.Output<outputs.elasticmetal.BareMetalServerIp[]>;
    /**
     * (List of) The IPv4 addresses of the server.
     */
    public /*out*/ readonly ipv4s!: pulumi.Output<outputs.elasticmetal.BareMetalServerIpv4[]>;
    /**
     * (List of) The IPv6 addresses of the server.
     */
    public /*out*/ readonly ipv6s!: pulumi.Output<outputs.elasticmetal.BareMetalServerIpv6[]>;
    /**
     ...
     */
    public readonly options!: pulumi.Output<outputs.elasticmetal.BareMetalServerOption[] | undefined>;
    /**
     ...
     */
    public readonly privateNetworks!: pulumi.Output<outputs.elasticmetal.BareMetalServerPrivateNetwork[] | undefined>;
    /**
...
export interface BareMetalServerState {
     ...
     * (List of) The IPs of the server.
     */
    ips?: pulumi.Input<pulumi.Input<inputs.elasticmetal.BareMetalServerIp>[]>;
    /**
     * (List of) The IPv4 addresses of the server.
     */
    ipv4s?: pulumi.Input<pulumi.Input<inputs.elasticmetal.BareMetalServerIpv4>[]>;
    /**
     * (List of) The IPv6 addresses of the server.
     */
    ipv6s?: pulumi.Input<pulumi.Input<inputs.elasticmetal.BareMetalServerIpv6>[]>;
    /**
     * The name of the server.
     */
     ...
     * > The `options` block supports:
     */
    options?: pulumi.Input<pulumi.Input<inputs.elasticmetal.BareMetalServerOption>[]>;
    /**
     * The organization ID the server is associated with.
     */
     ...
     * The private networks to attach to the server. For more information, see [the documentation](https://www.scaleway.com/en/docs/compute/elastic-metal/how-to/use-private-networks/)
     */
    privateNetworks?: pulumi.Input<pulumi.Input<inputs.elasticmetal.BareMetalServerPrivateNetwork>[]>;
    /**
     * `projectId`) The ID of the project the server is associated with.
     */

...
def get_volume(name: Optional[str] = None,
    ...
    my_volume = scaleway.blockstorage.get_volume(volume_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:blockstorage/getVolume:getVolume', __args__, opts=opts, typ=GetVolumeResult).value

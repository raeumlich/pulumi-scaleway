...
class SQSCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SQSCredentialsPermissionsArgs'] permissions: . List of permissions associated to these credentials. Only one of permissions may be set.
...
class SQSCredentials(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 permissions: Optional[pulumi.Input[pulumi.InputType['SQSCredentialsPermissionsArgs']]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 region: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        main_sqs = scaleway.mnq.SQS("mainSQS")
        main_sqs_credentials = scaleway.mnq.SQSCredentials("mainSQSCredentials",
            project_id=main_sqs.project_id,
            permissions=scaleway.mnq.SQSCredentialsPermissionsArgs(
                can_manage=False,
                can_receive=True,
                can_publish=False,
            ))
        ...
        :param pulumi.Input[str] name: The unique name of the sqs credentials.
        :param pulumi.Input[pulumi.InputType['SQSCredentialsPermissionsArgs']] permissions: . List of permissions associated to these credentials. Only one of permissions may be set.
        :param pulumi.Input[str] project_id: `project_id`) The ID of the project the sqs is enabled for.
        :param pulumi.Input[str] region: `region`). The region in which sqs is enabled.
        """
        ...
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[str]] = None,
            region: Optional[pulumi.Input[str]] = None,
            secret_key: Optional[pulumi.Input[str]] = None) -> 'SQSCredentials':
        """

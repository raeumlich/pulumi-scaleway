...
def get_flexible_ips(project_id: Optional[str] = None,
    ...
    fips_by_tags = scaleway.elasticmetal.get_flexible_ips(tags=["a tag"])
    ...
    first = scaleway.elasticmetal.FlexibleIP("first",
        server_id=base.id,
        tags=[
            "foo",
            "first",
        ])
    second = scaleway.elasticmetal.FlexibleIP("second",
        server_id=base.id,
        tags=[
            "foo",
            "second",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:elasticmetal/getFlexibleIPs:getFlexibleIPs', __args__, opts=opts, typ=GetFlexibleIPsResult).value

...
def get_bare_metal_server(name: Optional[str] = None,
    ...
    by_name = scaleway.elasticmetal.get_bare_metal_server(name="foobar",
        zone="fr-par-2")
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:elasticmetal/getBareMetalServer:getBareMetalServer', __args__, opts=opts, typ=GetBareMetalServerResult).value
...
def get_bare_metal_server_output(name: Optional[pulumi.Input[Optional[str]]] = None,

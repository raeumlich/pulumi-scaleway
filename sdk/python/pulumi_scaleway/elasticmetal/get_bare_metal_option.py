...
__all__ = [
    ...
    'get_bare_metal_option',
    'get_bare_metal_option_output',
]
...
def get_bare_metal_option(name: Optional[str] = None,
    ...
    by_name = scaleway.elasticmetal.get_bare_metal_option(name="Remote Access")
    by_id = scaleway.elasticmetal.get_bare_metal_option(option_id="931df052-d713-4674-8b58-96a63244c8e2")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:elasticmetal/getBareMetalOption:getBareMetalOption', __args__, opts=opts, typ=GetBareMetalOptionResult).value
...
@_utilities.lift_output_func(get_bare_metal_option)
def get_bare_metal_option_output(name: Optional[pulumi.Input[Optional[str]]] = None,

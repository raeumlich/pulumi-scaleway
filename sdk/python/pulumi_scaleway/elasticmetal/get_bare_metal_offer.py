...
__all__ = [
    ...
    'get_bare_metal_offer',
    'get_bare_metal_offer_output',
]
...
def get_bare_metal_offer(include_disabled: Optional[bool] = None,
    ...
    my_offer = scaleway.elasticmetal.get_bare_metal_offer(offer_id="25dcf38b-c90c-4b18-97a2-6956e9d1e113",
        zone="fr-par-2")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:elasticmetal/getBareMetalOffer:getBareMetalOffer', __args__, opts=opts, typ=GetBareMetalOfferResult).value
...
@_utilities.lift_output_func(get_bare_metal_offer)
def get_bare_metal_offer_output(include_disabled: Optional[pulumi.Input[Optional[bool]]] = None,

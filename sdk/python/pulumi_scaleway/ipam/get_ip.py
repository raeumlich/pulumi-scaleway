...
def get_ip(attached: Optional[bool] = None,
           ...
           resource: Optional[pulumi.InputType['GetIPResourceArgs']] = None,
    ...
    :param pulumi.InputType['GetIPResourceArgs'] resource: Filter by resource ID, type or name. Cannot be used with `ipam_ip_id`.
...
def get_ip_output(attached: Optional[pulumi.Input[Optional[bool]]] = None,
                  ...
                  resource: Optional[pulumi.Input[Optional[pulumi.InputType['GetIPResourceArgs']]]] = None,

...
class PrivateNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ipv4_subnet: Optional[pulumi.Input[pulumi.InputType['PrivateNetworkIpv4SubnetArgs']]] = None,
                 ipv6_subnets: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PrivateNetworkIpv6SubnetArgs']]]]] = None,
                 is_regional: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 region: Optional[pulumi.Input[str]] = None,
        ...
        pn_priv = scaleway.vpc.PrivateNetwork("pnPriv", tags=[
            "demo",
            "terraform",
        ])
        ```
        ...
        pn_priv = scaleway.vpc.PrivateNetwork("pnPriv",
            ipv4_subnet=scaleway.vpc.PrivateNetworkIpv4SubnetArgs(
                subnet="192.168.0.0/24",
            ),
            ipv6_subnets=[
                scaleway.vpc.PrivateNetworkIpv6SubnetArgs(
        ...
        :param pulumi.Input[pulumi.InputType['PrivateNetworkIpv4SubnetArgs']] ipv4_subnet: The IPv4 subnet to associate with the private network.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PrivateNetworkIpv6SubnetArgs']]]] ipv6_subnets: The IPv6 subnets to associate with the private network.
        :param pulumi.Input[bool] is_regional: The private networks are necessarily regional now.
        :param pulumi.Input[str] name: The name of the private network. If not provided it will be randomly generated.
        :param pulumi.Input[str] project_id: `project_id`) The ID of the project the private network is associated with.
        :param pulumi.Input[str] region: `region`) The region of the private network.

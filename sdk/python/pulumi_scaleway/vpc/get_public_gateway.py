...
__all__ = [
    'GetPublicGatewayResult',
    'AwaitableGetPublicGatewayResult',
    'get_public_gateway',
    'get_public_gateway_output',
]

@pulumi.output_type
class GetPublicGatewayResult:
    """
...
class AwaitableGetPublicGatewayResult(GetPublicGatewayResult):
...
def get_public_gateway(name: Optional[str] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPublicGatewayResult:
    """
    ...
    main = scaleway.vpc.PublicGateway("main",
        type="VPC-GW-S",
        zone="nl-ams-1")
    pg_test_by_name = scaleway.vpc.get_public_gateway_output(name=main.name,
        zone="nl-ams-1")
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:vpc/getPublicGateway:getPublicGateway', __args__, opts=opts, typ=GetPublicGatewayResult).value
...
@_utilities.lift_output_func(get_public_gateway)
def get_public_gateway_output(name: Optional[pulumi.Input[Optional[str]]] = None,
                              project_id: Optional[pulumi.Input[Optional[str]]] = None,
                              public_gateway_id: Optional[pulumi.Input[Optional[str]]] = None,
                              zone: Optional[pulumi.Input[Optional[str]]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPublicGatewayResult]:
    """
    Gets information about a public gateway.

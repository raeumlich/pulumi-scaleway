...
def get_public_gateway_pat_rule(pat_rule_id: Optional[str] = None,
    ...
    sg01 = scaleway.instance.SecurityGroup("sg01",
        ...
        inbound_rules=[scaleway.instance.SecurityGroupInboundRuleArgs(
            action="accept",
            port=22,
            protocol="TCP",
        )])
    ...
    dhcp01 = scaleway.vpc.PublicGatewayDHCP("dhcp01", subnet="192.168.0.0/24")
    ip01 = scaleway.vpc.PublicGatewayIP("ip01")
    pg01 = scaleway.vpc.PublicGateway("pg01",
        type="VPC-GW-S",
        ip_id=ip01.id)
    gn01 = scaleway.vpc.GatewayNetwork("gn01",
        gateway_id=pg01.id,
        private_network_id=pn01.id,
        dhcp_id=dhcp01.id,
        cleanup_dhcp=True,
        enable_masquerade=True)
    rsv01 = scaleway.vpc.PublicGatewayDHCPReservation("rsv01",
        gateway_network_id=gn01.id,
        mac_address=pnic01.mac_address,
        ip_address="192.168.0.7")
    pat01 = scaleway.vpc.PublicGatewayPATRule("pat01",
        gateway_id=pg01.id,
        private_ip=rsv01.ip_address,
        private_port=22,
        public_port=2202,
        protocol="tcp")
    main = scaleway.vpc.get_public_gateway_pat_rule_output(pat_rule_id=pat01.id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:vpc/getPublicGatewayPATRule:getPublicGatewayPATRule', __args__, opts=opts, typ=GetPublicGatewayPATRuleResult).value
...
@_utilities.lift_output_func(get_public_gateway_pat_rule)
def get_public_gateway_pat_rule_output(pat_rule_id: Optional[pulumi.Input[str]] = None,
                                       zone: Optional[pulumi.Input[Optional[str]]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPublicGatewayPATRuleResult]:
    """
    Gets information about a public gateway PAT rule. For further information please check the
    API [documentation](https://developers.scaleway.com/en/products/vpc-gw/api/v1/#get-8faeea)

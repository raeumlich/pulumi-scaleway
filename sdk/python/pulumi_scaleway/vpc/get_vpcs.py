...
def get_vpcs(name: Optional[str] = None,
    ...
    my_key = scaleway.vpc.get_vpcs(name="tf-vpc-datasource",
        region="nl-ams")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:vpc/getVPCs:getVPCs', __args__, opts=opts, typ=GetVPCsResult).value

...
class GatewayNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GatewayNetworkIpamConfigArgs']]] ipam_configs: Auto-configure the Gateway Network using Scaleway's IPAM (IP address management service). Only one of `dhcp_id`, `static_address` and `ipam_config` should be specified.
...
class GatewayNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 enable_masquerade: Optional[pulumi.Input[bool]] = None,
                 gateway_id: Optional[pulumi.Input[str]] = None,
                 ipam_configs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GatewayNetworkIpamConfigArgs']]]]] = None,
                 private_network_id: Optional[pulumi.Input[str]] = None,
                 static_address: Optional[pulumi.Input[str]] = None,
                 zone: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        vpc01 = scaleway.vpc.VPC("vpc01")
        pn01 = scaleway.vpc.PrivateNetwork("pn01",
            ipv4_subnet=scaleway.vpc.PrivateNetworkIpv4SubnetArgs(
                subnet="172.16.64.0/22",
            ),
            vpc_id=vpc01.id)
        pg01 = scaleway.vpc.PublicGateway("pg01", type="VPC-GW-S")
        main = scaleway.vpc.GatewayNetwork("main",
            gateway_id=pg01.id,
            private_network_id=pn01.id,
            enable_masquerade=True,
            ipam_configs=[scaleway.vpc.GatewayNetworkIpamConfigArgs(
        ...
        pn01 = scaleway.vpc.PrivateNetwork("pn01")
        gw01 = scaleway.vpc.PublicGatewayIP("gw01")
        dhcp01 = scaleway.vpc.PublicGatewayDHCP("dhcp01",
            subnet="192.168.1.0/24",
            push_default_route=True)
        pg01 = scaleway.vpc.PublicGateway("pg01",
            type="VPC-GW-S",
            ip_id=gw01.id)
        main = scaleway.vpc.GatewayNetwork("main",
            gateway_id=pg01.id,
        ...
        :param pulumi.Input[bool] enable_masquerade: Enable masquerade on this network
        :param pulumi.Input[str] gateway_id: The ID of the public gateway.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GatewayNetworkIpamConfigArgs']]]] ipam_configs: Auto-configure the Gateway Network using Scaleway's IPAM (IP address management service). Only one of `dhcp_id`, `static_address` and `ipam_config` should be specified.
        :param pulumi.Input[str] private_network_id: The ID of the private network.
        :param pulumi.Input[str] static_address: Enable DHCP config on this network. Only one of `dhcp_id`, `static_address` and `ipam_config` should be specified.
        :param pulumi.Input[str] zone: `zone`) The zone in which the gateway network should be created.
        """

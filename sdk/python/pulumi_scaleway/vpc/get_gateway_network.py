...
__all__ = [
    'GetGatewayNetworkResult',
    'AwaitableGetGatewayNetworkResult',
    'get_gateway_network',
    'get_gateway_network_output',
]

@pulumi.output_type
class GetGatewayNetworkResult:
    """
    ...
    def ipam_configs(self) -> Sequence['outputs.GetGatewayNetworkIpamConfigResult']:
...
class AwaitableGetGatewayNetworkResult(GetGatewayNetworkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGatewayNetworkResult(
...
def get_gateway_network(dhcp_id: Optional[str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewayNetworkResult:
    """
    ...
    by_id = scaleway.vpc.get_gateway_network_output(gateway_network_id=main.id)
    by_gateway_and_pn = scaleway.vpc.get_gateway_network(gateway_id=scaleway_vpc_public_gateway["pg01"]["id"],
        private_network_id=scaleway_vpc_private_network["pn01"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:vpc/getGatewayNetwork:getGatewayNetwork', __args__, opts=opts, typ=GetGatewayNetworkResult).value

    return AwaitableGetGatewayNetworkResult(
...
@_utilities.lift_output_func(get_gateway_network)
def get_gateway_network_output(dhcp_id: Optional[pulumi.Input[Optional[str]]] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGatewayNetworkResult]:
    """
    Gets information about a gateway network.

...
__all__ = [
    'GetPublicGatewayDHCPResult',
    'AwaitableGetPublicGatewayDHCPResult',
    'get_public_gateway_dhcp',
    'get_public_gateway_dhcp_output',
]

@pulumi.output_type
class GetPublicGatewayDHCPResult:
    """
...
class AwaitableGetPublicGatewayDHCPResult(GetPublicGatewayDHCPResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPublicGatewayDHCPResult(
...
def get_public_gateway_dhcp(dhcp_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:vpc/getPublicGatewayDHCP:getPublicGatewayDHCP', __args__, opts=opts, typ=GetPublicGatewayDHCPResult).value

    return AwaitableGetPublicGatewayDHCPResult(
...
@_utilities.lift_output_func(get_public_gateway_dhcp)
def get_public_gateway_dhcp_output(dhcp_id: Optional[pulumi.Input[str]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPublicGatewayDHCPResult]:
    """
    Gets information about a public gateway DHCP.

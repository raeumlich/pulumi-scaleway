...
def get_public_gateway_ip(ip_id: Optional[str] = None,
    ...
    main = scaleway.vpc.PublicGatewayIP("main")
    ip_by_id = scaleway.vpc.get_public_gateway_ip_output(ip_id=main.id)
    ```
    """
    __args__ = dict()
    __args__['ipId'] = ip_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('scaleway:vpc/getPublicGatewayIP:getPublicGatewayIP', __args__, opts=opts, typ=GetPublicGatewayIPResult).value
...
@_utilities.lift_output_func(get_public_gateway_ip)
def get_public_gateway_ip_output(ip_id: Optional[pulumi.Input[Optional[str]]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPublicGatewayIPResult]:
    """
    Gets information about a public gateway IP.

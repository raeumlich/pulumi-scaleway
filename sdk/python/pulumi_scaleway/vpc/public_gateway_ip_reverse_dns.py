...
__all__ = ['PublicGatewayIPReverseDNSArgs', 'PublicGatewayIPReverseDNS']
...
class PublicGatewayIPReverseDNS(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        tf_a = scaleway.dns.Record("tfA",
            dns_zone="example.com",
            type="A",
            data=main_public_gateway_ip.address,
            ttl=3600,
            priority=1)
        main_public_gateway_ip_reverse_dns = scaleway.vpc.PublicGatewayIPReverseDNS("mainPublicGatewayIPReverseDNS",
            gateway_ip_id=main_public_gateway_ip.id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PublicGatewayIPReverseDNSArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PublicGatewayIPReverseDNSArgs.__new__(PublicGatewayIPReverseDNSArgs)
        ...
        super(PublicGatewayIPReverseDNS, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _PublicGatewayIPReverseDNSState.__new__(_PublicGatewayIPReverseDNSState)

        __props__.__dict__["gateway_ip_id"] = gateway_ip_id
        __props__.__dict__["reverse"] = reverse
        __props__.__dict__["zone"] = zone
        return PublicGatewayIPReverseDNS(resource_name, opts=opts, __props__=__props__)

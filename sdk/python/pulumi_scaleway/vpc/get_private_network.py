...
class GetPrivateNetworkResult:
    ...
    def ipv4_subnets(self) -> Sequence['outputs.GetPrivateNetworkIpv4SubnetResult']:
        """
    ...
    def ipv6_subnets(self) -> Sequence['outputs.GetPrivateNetworkIpv6SubnetResult']:
        """
...
def get_private_network(name: Optional[str] = None,
    ...
    my_name = scaleway.vpc.get_private_network(name="foobar")
    my_name_and_vpc_id = scaleway.vpc.get_private_network(name="foobar",
        vpc_id="11111111-1111-1111-1111-111111111111")
    my_id = scaleway.vpc.get_private_network(private_network_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:vpc/getPrivateNetwork:getPrivateNetwork', __args__, opts=opts, typ=GetPrivateNetworkResult).value
...
def get_private_network_output(name: Optional[pulumi.Input[Optional[str]]] = None,

...
class ServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServerRootVolumeArgs'] root_volume: Root [volume](https://developers.scaleway.com/en/products/instance/api/#volumes-7e8a39) attached to the server on creation.
...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 placement_group_id: Optional[pulumi.Input[str]] = None,
                 private_networks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServerPrivateNetworkArgs']]]]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 public_ips: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServerPublicIpArgs']]]]] = None,
                 replace_on_type_change: Optional[pulumi.Input[bool]] = None,
                 root_volume: Optional[pulumi.Input[pulumi.InputType['ServerRootVolumeArgs']]] = None,
                 routed_ip_enabled: Optional[pulumi.Input[bool]] = None,
                 security_group_id: Optional[pulumi.Input[str]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
        ...
        public_ip = scaleway.instance.IP("publicIp")
        ...
        data = scaleway.instance.Volume("data",
            size_in_gb=100,
            type="b_ssd")
        web = scaleway.instance.Server("web",
            type="DEV1-S",
        ...
        www = scaleway.instance.SecurityGroup("www",
            ...
            outbound_rules=[scaleway.instance.SecurityGroupOutboundRuleArgs(
                action="drop",
        ...
        pn01 = scaleway.vpc.PrivateNetwork("pn01")
        ...
        snapshot = scaleway.instance.get_snapshot(name="my_snapshot")
        from_snapshot_volume = scaleway.instance.Volume("fromSnapshotVolume",
            from_snapshot_id=snapshot.id,
            type="b_ssd")
        from_snapshot_server = scaleway.instance.Server("fromSnapshotServer",
            type="PRO2-XXS",
            root_volume=scaleway.instance.ServerRootVolumeArgs(
        ...
        :param pulumi.Input[str] placement_group_id: The [placement group](https://developers.scaleway.com/en/products/instance/api/#placement-groups-d8f653) the server is attached to.
               ...
               > **Important:** When updating `placement_group_id` the `state` must be set to `stopped`, otherwise it will fail.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServerPrivateNetworkArgs']]]] private_networks: The private network associated with the server.
               Use the `pn_id` key to attach a [private_network](https://developers.scaleway.com/en/products/instance/api/#private-nics-a42eea) on your instance.
        :param pulumi.Input[str] project_id: `project_id`) The ID of the project the server is associated with.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServerPublicIpArgs']]]] public_ips: The list of public IPs of the server.
        :param pulumi.Input[bool] replace_on_type_change: If true, the server will be replaced if `type` is changed. Otherwise, the server will migrate.
        :param pulumi.Input[pulumi.InputType['ServerRootVolumeArgs']] root_volume: Root [volume](https://developers.scaleway.com/en/products/instance/api/#volumes-7e8a39) attached to the server on creation.
        :param pulumi.Input[bool] routed_ip_enabled: If true, the server will support routed ips only. Changing it to true will migrate the server and its IP to routed type.

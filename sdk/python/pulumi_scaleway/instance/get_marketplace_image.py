...
def get_marketplace_image(instance_type: Optional[str] = None,
    ...
    my_image = scaleway.instance.get_marketplace_image(label="ubuntu_jammy")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:instance/getMarketplaceImage:getMarketplaceImage', __args__, opts=opts, typ=GetMarketplaceImageResult).value

...
def get_security_group(name: Optional[str] = None,
    ...
    my_key = scaleway.instance.get_security_group(security_group_id="11111111-1111-1111-1111-111111111111")
    ```
...
def get_security_group_output(name: Optional[pulumi.Input[Optional[str]]] = None,

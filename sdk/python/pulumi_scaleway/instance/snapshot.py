...
class Snapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 import_: Optional[pulumi.Input[pulumi.InputType['SnapshotImportArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 type: Optional[pulumi.Input[str]] = None,
        ...
        main = scaleway.instance.Snapshot("main", volume_id="11111111-1111-1111-1111-111111111111")
        ```
        ...
        main_volume = scaleway.instance.Volume("mainVolume",
            type="l_ssd",
            size_in_gb=10)
        main_server = scaleway.instance.Server("mainServer",
            ...
            additional_volume_ids=[main_volume.id])
        main_snapshot = scaleway.instance.Snapshot("mainSnapshot",
        ...
        qcow = scaleway.objectstorage.Item("qcow",
            bucket=bucket.name,
            key="server.qcow2",
            file="myqcow.qcow2")
        snapshot = scaleway.instance.Snapshot("snapshot",
            type="unified",
            import_=scaleway.instance.SnapshotImportArgs(
                bucket=qcow.bucket,
                key=qcow.key,
            ))
        ```
        ...
        :param pulumi.Input[pulumi.InputType['SnapshotImportArgs']] import_: Import a snapshot from a qcow2 file located in a bucket
        :param pulumi.Input[str] name: The name of the snapshot. If not provided it will be randomly generated.
        :param pulumi.Input[str] project_id: `project_id`) The ID of the project the snapshot is
               associated with.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: A list of tags to apply to the snapshot.

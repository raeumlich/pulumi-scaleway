...
def get_load_balancer(lb_id: Optional[str] = None,
    ...
    by_name = scaleway.loadbalancer.get_load_balancer(name="foobar")
    by_id = scaleway.loadbalancer.get_load_balancer(lb_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getLoadBalancer:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value

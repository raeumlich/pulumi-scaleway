...
def get_routes(frontend_id: Optional[str] = None,
    ...
    by_frontend_id = scaleway.loadbalancer.get_routes(frontend_id=scaleway_lb_frontend["frt01"]["id"])
    my_key = scaleway.loadbalancer.get_routes(frontend_id="11111111-1111-1111-1111-111111111111",
        zone="fr-par-2")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getRoutes:getRoutes', __args__, opts=opts, typ=GetRoutesResult).value
...
def get_routes_output(frontend_id: Optional[pulumi.Input[Optional[str]]] = None,

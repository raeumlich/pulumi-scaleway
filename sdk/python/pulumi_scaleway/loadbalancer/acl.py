...
class ACLArgs:
    ...
    @property
    @pulumi.getter
    def action(self) -> pulumi.Input['ACLActionArgs']:
        """
    ...
    @action.setter
    def action(self, value: pulumi.Input['ACLActionArgs']):
...
class ACL(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 action: Optional[pulumi.Input[pulumi.InputType['ACLActionArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 frontend_id: Optional[pulumi.Input[str]] = None,
                 index: Optional[pulumi.Input[int]] = None,
                 match: Optional[pulumi.Input[pulumi.InputType['ACLMatchArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        acl01 = scaleway.loadbalancer.ACL("acl01",
            frontend_id=scaleway_lb_frontend["frt01"]["id"],
            description="Exclude well-known IPs",
            index=0,
            action=scaleway.loadbalancer.ACLActionArgs(
                type="allow",
            ),
            match=scaleway.loadbalancer.ACLMatchArgs(
                ip_subnets=[
                    "192.168.0.1",
                    "192.168.0.2",
                    "192.168.10.0/24",
        ...
        :param pulumi.Input[pulumi.InputType['ACLActionArgs']] action: Action to undertake when an ACL filter matches.
        :param pulumi.Input[str] description: The ACL description.
        :param pulumi.Input[str] frontend_id: The load-balancer Frontend ID to attach the ACL to.
        :param pulumi.Input[int] index: The Priority of this ACL (ACLs are applied in ascending order, 0 is the first ACL executed).
        :param pulumi.Input[pulumi.InputType['ACLMatchArgs']] match: The ACL match rule. At least `ip_subnet` or `http_filter` and `http_filter_value` are required.
        :param pulumi.Input[str] name: The ACL name. If not provided it will be randomly generated.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            match: Optional[pulumi.Input[pulumi.InputType['ACLMatchArgs']]] = None,
            name: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'ACL':
        """
    ...
    @property
    @pulumi.getter
    def action(self) -> pulumi.Output['outputs.ACLAction']:
        """
        Action to undertake when an ACL filter matches.
        """
        return pulumi.get(self, "action")

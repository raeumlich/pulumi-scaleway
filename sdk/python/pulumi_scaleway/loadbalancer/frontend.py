...
class Frontend(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 acls: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FrontendAclArgs']]]]] = None,
                 backend_id: Optional[pulumi.Input[str]] = None,
                 certificate_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 enable_http3: Optional[pulumi.Input[bool]] = None,
                 external_acls: Optional[pulumi.Input[bool]] = None,
        ...
        frontend01 = scaleway.loadbalancer.Frontend("frontend01",
        ...
        frontend01 = scaleway.loadbalancer.Frontend("frontend01",
            ...
            inbound_port=80,
            acls=[
                scaleway.loadbalancer.FrontendAclArgs(
                    name="blacklist wellknwon IPs",
                    action=scaleway.loadbalancer.FrontendAclActionArgs(
                        type="allow",
                    ),
                    match=scaleway.loadbalancer.FrontendAclMatchArgs(
                        ip_subnets=[
                            "192.168.0.1",
                            "192.168.0.2",
                            "192.168.10.0/24",
                ...
                scaleway.loadbalancer.FrontendAclArgs(
                    action=scaleway.loadbalancer.FrontendAclActionArgs(
                        type="redirect",
                        redirects=[scaleway.loadbalancer.FrontendAclActionRedirectArgs(
                            type="location",
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FrontendAclArgs']]]] acls: A list of ACL rules to apply to the load-balancer frontend.  Defined below.
        :param pulumi.Input[str] backend_id: The load-balancer backend ID this frontend is attached to.

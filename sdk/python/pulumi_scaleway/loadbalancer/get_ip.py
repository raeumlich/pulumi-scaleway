...
def get_ip(ip_address: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getIP:getIP', __args__, opts=opts, typ=GetIPResult).value
...
def get_ip_output(ip_address: Optional[pulumi.Input[Optional[str]]] = None,

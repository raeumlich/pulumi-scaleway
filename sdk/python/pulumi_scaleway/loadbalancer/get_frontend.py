...
def get_frontend(frontend_id: Optional[str] = None,
    ...
    ip01 = scaleway.loadbalancer.IP("ip01")
    lb01 = scaleway.loadbalancer.LoadBalancer("lb01",
        ip_id=ip01.id,
        type="lb-s")
    bkd01 = scaleway.loadbalancer.Backend("bkd01",
        lb_id=lb01.id,
        forward_protocol="tcp",
        forward_port=80,
        proxy_protocol="none")
    frt01 = scaleway.loadbalancer.Frontend("frt01",
        lb_id=lb01.id,
        backend_id=bkd01.id,
        inbound_port=80)
    by_id = scaleway.loadbalancer.get_frontend_output(frontend_id=frt01.id)
    by_name = scaleway.loadbalancer.get_frontend_output(name=frt01.name,
        lb_id=lb01.id)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getFrontend:getFrontend', __args__, opts=opts, typ=GetFrontendResult).value
...
@_utilities.lift_output_func(get_frontend)
def get_frontend_output(frontend_id: Optional[pulumi.Input[Optional[str]]] = None,
                        lb_id: Optional[pulumi.Input[Optional[str]]] = None,
                        name: Optional[pulumi.Input[Optional[str]]] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFrontendResult]:
    """
    Get information about Scaleway Load-Balancer Frontends.
    For more information, see [the documentation](https://www.scaleway.com/en/developers/api/load-balancer/zoned-api/#path-frontends).

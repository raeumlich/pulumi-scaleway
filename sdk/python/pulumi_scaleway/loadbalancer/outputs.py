...
__all__ = [
    ...
    'CertficateCustomCertificate',
    'CertficateLetsencrypt',
    'FrontendAcl',
    'FrontendAclAction',
...
@pulumi.output_type
class CertficateCustomCertificate(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CertficateCustomCertificate. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CertficateCustomCertificate.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class CertficateLetsencrypt(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "commonName":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CertficateLetsencrypt. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CertficateLetsencrypt.__key_warning(key)
        return super().__getitem__(key)
...
class GetACLsAclResult(dict):
    def __init__(__self__, *,
                 ...
                 update_at: str):
        """
        :param Sequence['GetACLsAclActionArgs'] actions: The action that has been undertaken when an ACL filter had matched.
...
class GetBackendsBackendResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['GetBackendsBackendHealthCheckHttpArgs'] health_check_http: This block enable HTTP health check.
        :param Sequence['GetBackendsBackendHealthCheckHttpArgs'] health_check_https: This block enable HTTPS health check.
        ...
        :param Sequence['GetBackendsBackendHealthCheckTcpArgs'] health_check_tcps: This block enable TCP health check.

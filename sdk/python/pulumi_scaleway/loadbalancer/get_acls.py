...
def get_acls(frontend_id: Optional[str] = None,
    ...
    by_front_id = scaleway.loadbalancer.get_acls(frontend_id=scaleway_lb_frontend["frt01"]["id"])
    by_front_id_and_name = scaleway.loadbalancer.get_acls(frontend_id=scaleway_lb_frontend["frt01"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getACLs:getACLs', __args__, opts=opts, typ=GetACLsResult).value
...
def get_acls_output(frontend_id: Optional[pulumi.Input[str]] = None,

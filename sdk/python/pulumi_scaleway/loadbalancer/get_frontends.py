...
__all__ = [
    'GetFrontendsResult',
    'AwaitableGetFrontendsResult',
    'get_frontends',
    'get_frontends_output',
]

@pulumi.output_type
class GetFrontendsResult:
    """
    ...
    @property
    @pulumi.getter
    def frontends(self) -> Sequence['outputs.GetFrontendsFrontendResult']:
        """
...
class AwaitableGetFrontendsResult(GetFrontendsResult):
...
def get_frontends(lb_id: Optional[str] = None,
                  name: Optional[str] = None,
                  project_id: Optional[str] = None,
                  zone: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFrontendsResult:
    """
    ...
    by_lbid = scaleway.loadbalancer.get_frontends(lb_id=scaleway_lb["lb01"]["id"])
    by_lbid_and_name = scaleway.loadbalancer.get_frontends(lb_id=scaleway_lb["lb01"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getFrontends:getFrontends', __args__, opts=opts, typ=GetFrontendsResult).value

    return AwaitableGetFrontendsResult(
...
@_utilities.lift_output_func(get_frontends)
def get_frontends_output(lb_id: Optional[pulumi.Input[str]] = None,
                         name: Optional[pulumi.Input[Optional[str]]] = None,
                         project_id: Optional[pulumi.Input[Optional[str]]] = None,
                         zone: Optional[pulumi.Input[Optional[str]]] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFrontendsResult]:
    """
    Gets information about multiple Load Balancer Frontends.

...
def get_route(route_id: Optional[str] = None,
    ...
    frt01 = scaleway.loadbalancer.Frontend("frt01",
        ...
        backend_id=bkd01.id,
        inbound_port=80)
    rt01 = scaleway.loadbalancer.Route("rt01",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getRoute:getRoute', __args__, opts=opts, typ=GetRouteResult).value

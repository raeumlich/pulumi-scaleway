...
__all__ = ['CertficateArgs', 'Certficate']

@pulumi.input_type
class CertficateArgs:
    def __init__(__self__, *,
                 lb_id: pulumi.Input[str],
                 custom_certificate: Optional[pulumi.Input['CertficateCustomCertificateArgs']] = None,
                 letsencrypt: Optional[pulumi.Input['CertficateLetsencryptArgs']] = None,
        ...
        :param pulumi.Input['CertficateCustomCertificateArgs'] custom_certificate: Configuration block for custom certificate chain. Only one of `letsencrypt` and `custom_certificate` should be specified.
        :param pulumi.Input['CertficateLetsencryptArgs'] letsencrypt: Configuration block for Let's Encrypt configuration. Only one of `letsencrypt` and `custom_certificate` should be specified.
    ...
    def custom_certificate(self) -> Optional[pulumi.Input['CertficateCustomCertificateArgs']]:
        """
    ...
    def custom_certificate(self, value: Optional[pulumi.Input['CertficateCustomCertificateArgs']]):
        pulumi.set(self, "custom_certificate", value)

    @property
    @pulumi.getter
    def letsencrypt(self) -> Optional[pulumi.Input['CertficateLetsencryptArgs']]:
        """
    ...
    @letsencrypt.setter
    def letsencrypt(self, value: Optional[pulumi.Input['CertficateLetsencryptArgs']]):
...
class Certficate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 custom_certificate: Optional[pulumi.Input[pulumi.InputType['CertficateCustomCertificateArgs']]] = None,
                 lb_id: Optional[pulumi.Input[str]] = None,
                 letsencrypt: Optional[pulumi.Input[pulumi.InputType['CertficateLetsencryptArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a Certficate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['CertficateCustomCertificateArgs']] custom_certificate: Configuration block for custom certificate chain. Only one of `letsencrypt` and `custom_certificate` should be specified.
        :param pulumi.Input[str] lb_id: The load-balancer ID this certificate is attached to.
               
               > **Important:** Updates to `lb_id` will recreate the load-balancer certificate.
        :param pulumi.Input[pulumi.InputType['CertficateLetsencryptArgs']] letsencrypt: Configuration block for Let's Encrypt configuration. Only one of `letsencrypt` and `custom_certificate` should be specified.
        :param pulumi.Input[str] name: The name of the certificate backend.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        Create a Certficate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CertficateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CertficateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CertficateArgs.__new__(CertficateArgs)
        ...
        super(Certficate, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            not_valid_before: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            subject_alternative_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'Certficate':
        """
        ...
        __props__ = _CertficateState.__new__(_CertficateState)
        ...
        return Certficate(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="customCertificate")
    def custom_certificate(self) -> pulumi.Output[Optional['outputs.CertficateCustomCertificate']]:
        """
        Configuration block for custom certificate chain. Only one of `letsencrypt` and `custom_certificate` should be specified.
        """
        return pulumi.get(self, "custom_certificate")
    ...
    @property
    @pulumi.getter
    def letsencrypt(self) -> pulumi.Output[Optional['outputs.CertficateLetsencrypt']]:
        """
        Configuration block for Let's Encrypt configuration. Only one of `letsencrypt` and `custom_certificate` should be specified.
        """
        return pulumi.get(self, "letsencrypt")

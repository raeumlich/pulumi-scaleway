...
def get_certificate(certificate_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getCertificate:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(certificate_id: Optional[pulumi.Input[Optional[str]]] = None,

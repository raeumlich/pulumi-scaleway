...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        main = scaleway.loadbalancer.IP("main", zone="fr-par-1")
        base = scaleway.loadbalancer.LoadBalancer("base",
            ip_id=main.id,
            zone=main.zone,
            type="LB-S")
        ```
        ...
        Since v1.15.0, `ip_id` is a required field. This means that now a separate `loadbalancer.IP` is required.
        ...
        main = scaleway.loadbalancer.LoadBalancer("main",
            type="LB-S",
            zone="fr-par-1")
        ```
        <!--End PulumiCodeChooser -->

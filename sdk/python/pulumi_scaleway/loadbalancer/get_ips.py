...
def get_ips(ip_cidr_range: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:loadbalancer/getIPs:getIPs', __args__, opts=opts, typ=GetIPsResult).value
...
def get_ips_output(ip_cidr_range: Optional[pulumi.Input[Optional[str]]] = None,

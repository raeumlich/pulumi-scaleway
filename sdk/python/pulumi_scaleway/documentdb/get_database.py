...
def get_database(instance_id: Optional[str] = None,
    ...
    main = scaleway.documentdb.get_database(instance_id="11111111-1111-1111-1111-111111111111",
        name="foobar")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:documentdb/getDatabase:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value

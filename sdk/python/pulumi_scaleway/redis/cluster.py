...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 acls: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ClusterAclArgs']]]]] = None,
                 cluster_size: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 node_type: Optional[pulumi.Input[str]] = None,
                 password: Optional[pulumi.Input[str]] = None,
                 private_networks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ClusterPrivateNetworkArgs']]]]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 public_network: Optional[pulumi.Input[pulumi.InputType['ClusterPublicNetworkArgs']]] = None,
                 settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tls_enabled: Optional[pulumi.Input[bool]] = None,
                 user_name: Optional[pulumi.Input[str]] = None,
        ...
        main = scaleway.redis.Cluster("main",
            acls=[scaleway.redis.ClusterAclArgs(
        ...
        main = scaleway.redis.Cluster("main",
            ...
            password="thiZ_is_v&ry_s3cret",
            cluster_size=1,
            private_networks=[scaleway.redis.ClusterPrivateNetworkArgs(
                id=pn.id,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ClusterAclArgs']]]] acls: List of acl rules, this is cluster's authorized IPs. More details on the ACL section.
        :param pulumi.Input[int] cluster_size: The number of nodes in the Redis Cluster.
        ...
        :param pulumi.Input[str] node_type: The type of Redis Cluster you want to create (e.g. `RED1-M`).
               ...
               you cannot downgrade a Redis Cluster.
        :param pulumi.Input[str] password: Password for the first user of the Redis Cluster.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ClusterPrivateNetworkArgs']]]] private_networks: Describes the private network you want to connect to your cluster. If not set, a public
               network will be provided. More details on the Private Network section
        :param pulumi.Input[str] project_id: `project_id`) The ID of the project the Redis Cluster is
               associated with.
        :param pulumi.Input[pulumi.InputType['ClusterPublicNetworkArgs']] public_network: (Optional) Public network details. Only one of `private_network` and `public_network` may be set.
               > The `public_network` block exports:
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] settings: Map of settings for redis cluster. Available settings can be found by listing redis versions
               with scaleway API or CLI
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: The tags associated with the Redis Cluster.

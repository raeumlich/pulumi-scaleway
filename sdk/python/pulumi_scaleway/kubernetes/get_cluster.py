...
class GetClusterResult:
    ...
    def auto_upgrades(self) -> Sequence['outputs.GetClusterAutoUpgradeResult']:
        """
    ...
    def autoscaler_configs(self) -> Sequence['outputs.GetClusterAutoscalerConfigResult']:
        """
    ...
    @property
    @pulumi.getter
    def kubeconfigs(self) -> Sequence['outputs.GetClusterKubeconfigResult']:
    ...
    def open_id_connect_configs(self) -> Sequence['outputs.GetClusterOpenIdConnectConfigResult']:
...
def get_cluster(cluster_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:kubernetes/getCluster:getCluster', __args__, opts=opts, typ=GetClusterResult).value

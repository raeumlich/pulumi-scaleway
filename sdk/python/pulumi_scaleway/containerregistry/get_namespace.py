...
def get_namespace(name: Optional[str] = None,
    ...
    my_namespace = scaleway.containerregistry.get_namespace(namespace_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:containerregistry/getNamespace:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value

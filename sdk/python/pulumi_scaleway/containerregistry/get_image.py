...
def get_image(image_id: Optional[str] = None,
    ...
    my_image = scaleway.containerregistry.get_image(image_id="11111111-1111-1111-1111-111111111111",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:containerregistry/getImage:getImage', __args__, opts=opts, typ=GetImageResult).value

...
class Device(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 allow_insecure: Optional[pulumi.Input[bool]] = None,
                 allow_multiple_connections: Optional[pulumi.Input[bool]] = None,
                 certificate: Optional[pulumi.Input[pulumi.InputType['DeviceCertificateArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 hub_id: Optional[pulumi.Input[str]] = None,
                 message_filters: Optional[pulumi.Input[pulumi.InputType['DeviceMessageFiltersArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 region: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        main_device = scaleway.iot.Device("mainDevice", hub_id=main_hub.id)
        ```
        ...
        main_device = scaleway.iot.Device("mainDevice",
            hub_id=main_hub.id,
            certificate=scaleway.iot.DeviceCertificateArgs(
        ...
        :param pulumi.Input[bool] allow_multiple_connections: Allow more than one simultaneous connection using the same device credentials.
               ...
               > **Important:** Updates to `allow_multiple_connections` can disconnect eventually connected devices.
        :param pulumi.Input[pulumi.InputType['DeviceCertificateArgs']] certificate: The certificate bundle of the device.
        :param pulumi.Input[str] description: The description of the IoT device (e.g. `living room`).
        :param pulumi.Input[str] hub_id: The ID of the hub on which this device will be created.
        :param pulumi.Input[pulumi.InputType['DeviceMessageFiltersArgs']] message_filters: Rules that define which messages are authorized or denied based on their topic.
        :param pulumi.Input[str] name: The name of the IoT device you want to create (e.g. `my-device`).
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'Device':
        """

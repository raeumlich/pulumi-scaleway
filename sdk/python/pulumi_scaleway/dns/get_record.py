...
class GetRecordResult:
    ...
    def geo_ips(self) -> Sequence['outputs.GetRecordGeoIpResult']:
        """
    ...
    def http_services(self) -> Sequence['outputs.GetRecordHttpServiceResult']:
        """
    ...
    @property
    @pulumi.getter
    def views(self) -> Sequence['outputs.GetRecordViewResult']:
        """
    ...
    @property
    @pulumi.getter
    def weighteds(self) -> Sequence['outputs.GetRecordWeightedResult']:
        """
...
def get_record(data: Optional[str] = None,
    ...
    by_content = scaleway.dns.get_record(data="1.2.3.4",
        dns_zone="domain.tld",
        name="www",
        type="A")
    by_id = scaleway.dns.get_record(dns_zone="domain.tld",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:dns/getRecord:getRecord', __args__, opts=opts, typ=GetRecordResult).value
...
def get_record_output(data: Optional[pulumi.Input[Optional[str]]] = None,

...
def get_offer(name: Optional[str] = None,
    ...
    by_name = scaleway.webhosting.get_offer(name="performance")
    by_id = scaleway.webhosting.get_offer(offer_id="de2426b4-a9e9-11ec-b909-0242ac120002")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:webhosting/getOffer:getOffer', __args__, opts=opts, typ=GetOfferResult).value
...
@_utilities.lift_output_func(get_offer)
def get_offer_output(name: Optional[pulumi.Input[Optional[str]]] = None,
                     offer_id: Optional[pulumi.Input[Optional[str]]] = None,
                     region: Optional[pulumi.Input[Optional[str]]] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOfferResult]:
    """
    Gets information about a webhosting offer.

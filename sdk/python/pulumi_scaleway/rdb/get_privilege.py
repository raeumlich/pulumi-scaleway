...
def get_privilege(database_name: Optional[str] = None,
    ...
    main = scaleway.rdb.get_privilege(database_name="my-database",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:rdb/getPrivilege:getPrivilege', __args__, opts=opts, typ=GetPrivilegeResult).value
...
@_utilities.lift_output_func(get_privilege)
def get_privilege_output(database_name: Optional[pulumi.Input[str]] = None,
                         instance_id: Optional[pulumi.Input[str]] = None,
                         region: Optional[pulumi.Input[Optional[str]]] = None,
                         user_name: Optional[pulumi.Input[str]] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPrivilegeResult]:
    """
    Gets information about the privilege on RDB database.

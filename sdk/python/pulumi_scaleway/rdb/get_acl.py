...
def get_acl(instance_id: Optional[str] = None,
    ...
    my_acl = scaleway.rdb.get_acl(instance_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:rdb/getACL:getACL', __args__, opts=opts, typ=GetACLResult).value

...
def get_database(instance_id: Optional[str] = None,
    ...
    my_db = scaleway.rdb.get_database(instance_id="11111111-1111-1111-1111-111111111111",
        name="foobar")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:rdb/getDatabase:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value

...
class Bucket(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        some_bucket = scaleway.objectstorage.Bucket("someBucket", tags={
            "key": "value",
        })
        ```
        ...
        main = scaleway.objectstorage.Bucket("main",
            lifecycle_rules=[
                scaleway.objectstorage.BucketLifecycleRuleArgs(
                    enabled=True,
                    expiration=scaleway.objectstorage.BucketLifecycleRuleExpirationArgs(
                        days=365,
                    ),
                    id="id1",
                    prefix="path1/",
                    transitions=[scaleway.objectstorage.BucketLifecycleRuleTransitionArgs(
                        days=120,
        ...
        :param pulumi.Input[bool] force_destroy: Enable deletion of objects in bucket before destroying, locked objects or under legal hold are also deleted and **not** recoverable
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BucketLifecycleRuleArgs']]]] lifecycle_rules: Lifecycle configuration is a set of rules that define actions that Scaleway Object Storage applies to a group of objects
        :param pulumi.Input[str] name: The name of the bucket.
        :param pulumi.Input[bool] object_lock_enabled: Enable object lock
        :param pulumi.Input[str] project_id: `project_id`) The ID of the project the bucket is associated with.

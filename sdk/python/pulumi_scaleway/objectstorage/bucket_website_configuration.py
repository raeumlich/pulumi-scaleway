...
class BucketWebsiteConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BucketWebsiteConfigurationIndexDocumentArgs'] index_document: The name of the index document for the website detailed below.
        :param pulumi.Input['BucketWebsiteConfigurationErrorDocumentArgs'] error_document: The name of the error document for the website detailed below.
...
class BucketWebsiteConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bucket: Optional[pulumi.Input[str]] = None,
                 error_document: Optional[pulumi.Input[pulumi.InputType['BucketWebsiteConfigurationErrorDocumentArgs']]] = None,
                 index_document: Optional[pulumi.Input[pulumi.InputType['BucketWebsiteConfigurationIndexDocumentArgs']]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 region: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        main_bucket = scaleway.objectstorage.Bucket("mainBucket", acl="public-read")
        main_bucket_website_configuration = scaleway.objectstorage.BucketWebsiteConfiguration("mainBucketWebsiteConfiguration",
            bucket=main_bucket.id,
            index_document=scaleway.objectstorage.BucketWebsiteConfigurationIndexDocumentArgs(
                suffix="index.html",
            ))
        ```
        ...
        main_bucket = scaleway.objectstorage.Bucket("mainBucket", acl="public-read")
        main_bucket_policy = scaleway.objectstorage.BucketPolicy("mainBucketPolicy",
            bucket=main_bucket.id,
            policy=json.dumps({
                "Version": "2012-10-17",
                "Id": "MyPolicy",
        ...
        :param pulumi.Input[str] bucket: The name of the bucket.
        :param pulumi.Input[pulumi.InputType['BucketWebsiteConfigurationErrorDocumentArgs']] error_document: The name of the error document for the website detailed below.
        :param pulumi.Input[pulumi.InputType['BucketWebsiteConfigurationIndexDocumentArgs']] index_document: The name of the index document for the website detailed below.
        :param pulumi.Input[str] project_id: The project_id you want to attach the resource to
        :param pulumi.Input[str] region: The region you want to attach the resource to
        """
        ...
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[str]] = None,
            website_domain: Optional[pulumi.Input[str]] = None,
            website_endpoint: Optional[pulumi.Input[str]] = None) -> 'BucketWebsiteConfiguration':
        """

...
def get_bucket(name: Optional[str] = None,
    ...
    main = scaleway.objectstorage.Bucket("main", tags={
        "foo": "bar",
    })
    selected = scaleway.objectstorage.get_bucket_output(name=main.id)
    ```
    ...
    selected = scaleway.objectstorage.get_bucket(name="bucket.test.com",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:objectstorage/getBucket:getBucket', __args__, opts=opts, typ=GetBucketResult).value
...
def get_bucket_output(name: Optional[pulumi.Input[Optional[str]]] = None,

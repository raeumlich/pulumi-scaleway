...
def get_function_namespace(name: Optional[str] = None,
    ...
    my_namespace = scaleway.serverless.get_function_namespace(namespace_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:serverless/getFunctionNamespace:getFunctionNamespace', __args__, opts=opts, typ=GetFunctionNamespaceResult).value

...
def get_function(function_id: Optional[str] = None,
    ...
    my_function = scaleway.serverless.get_function(function_id="11111111-1111-1111-1111-111111111111",
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:serverless/getFunction:getFunction', __args__, opts=opts, typ=GetFunctionResult).value

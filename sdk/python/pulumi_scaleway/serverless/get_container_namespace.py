...
def get_container_namespace(name: Optional[str] = None,
    ...
    by_name = scaleway.serverless.get_container_namespace(name="my-namespace-name")
    by_id = scaleway.serverless.get_container_namespace(namespace_id="11111111-1111-1111-1111-111111111111")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scaleway:serverless/getContainerNamespace:getContainerNamespace', __args__, opts=opts, typ=GetContainerNamespaceResult).value

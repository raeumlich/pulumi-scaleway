...
namespace Pulumi.Scaleway.Instance
{
    ...
    /// {
    ///     var serverVolume = new Scaleway.Instance.Volume("serverVolume", new()
    ///     {
    ///         SizeInGb = 20,
    ///         Type = "l_ssd",
    ///     });
    ...
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("scaleway:instance/volume:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, VolumeState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:instance/volume:Volume", name, state, MakeResourceOptions(options, id))
        {
        }

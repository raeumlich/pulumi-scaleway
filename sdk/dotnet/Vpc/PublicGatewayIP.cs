...
namespace Pulumi.Scaleway.Vpc
{
    ...
    /// {
    ///     var main = new Scaleway.Vpc.PublicGatewayIP("main", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:vpc/publicGatewayIP:PublicGatewayIP")]
    public partial class PublicGatewayIP : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public PublicGatewayIP(string name, PublicGatewayIPArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:vpc/publicGatewayIP:PublicGatewayIP", name, args ?? new PublicGatewayIPArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicGatewayIP(string name, Input<string> id, PublicGatewayIPState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:vpc/publicGatewayIP:PublicGatewayIP", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PublicGatewayIP Get(string name, Input<string> id, PublicGatewayIPState? state = null, CustomResourceOptions? options = null)
        {
            return new PublicGatewayIP(name, id, state, options);
        }
    }
    ...
    public sealed class PublicGatewayIPArgs : global::Pulumi.ResourceArgs
    {
        ...
        public PublicGatewayIPArgs()
        {
        }
        public static new PublicGatewayIPArgs Empty => new PublicGatewayIPArgs();
    }

    public sealed class PublicGatewayIPState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The IP address itself.
        /// </summary>
        ...
        public PublicGatewayIPState()
        {
        }
        public static new PublicGatewayIPState Empty => new PublicGatewayIPState();
    }
}

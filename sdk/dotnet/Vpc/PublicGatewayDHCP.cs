...
namespace Pulumi.Scaleway.Vpc
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:vpc/publicGatewayDHCP:PublicGatewayDHCP")]
    public partial class PublicGatewayDHCP : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public PublicGatewayDHCP(string name, PublicGatewayDHCPArgs args, CustomResourceOptions? options = null)
            : base("scaleway:vpc/publicGatewayDHCP:PublicGatewayDHCP", name, args ?? new PublicGatewayDHCPArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicGatewayDHCP(string name, Input<string> id, PublicGatewayDHCPState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:vpc/publicGatewayDHCP:PublicGatewayDHCP", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PublicGatewayDHCP Get(string name, Input<string> id, PublicGatewayDHCPState? state = null, CustomResourceOptions? options = null)
        {
            return new PublicGatewayDHCP(name, id, state, options);
        }
    }

    public sealed class PublicGatewayDHCPArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The IP address of the public gateway DHCP config.
        /// </summary>
        ...
        public PublicGatewayDHCPArgs()
        {
        }
        public static new PublicGatewayDHCPArgs Empty => new PublicGatewayDHCPArgs();
    }

    public sealed class PublicGatewayDHCPState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The IP address of the public gateway DHCP config.
        /// </summary>
        ...
        public PublicGatewayDHCPState()
        {
        }
        public static new PublicGatewayDHCPState Empty => new PublicGatewayDHCPState();
    }
}

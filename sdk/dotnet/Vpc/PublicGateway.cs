...
namespace Pulumi.Scaleway.Vpc
{
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:vpc/publicGateway:PublicGateway")]
    public partial class PublicGateway : global::Pulumi.CustomResource
    {
        ...
        public PublicGateway(string name, PublicGatewayArgs args, CustomResourceOptions? options = null)
            : base("scaleway:vpc/publicGateway:PublicGateway", name, args ?? new PublicGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicGateway(string name, Input<string> id, PublicGatewayState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:vpc/publicGateway:PublicGateway", name, state, MakeResourceOptions(options, id))
        {
        }

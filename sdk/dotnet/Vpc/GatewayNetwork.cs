...
namespace Pulumi.Scaleway.Vpc
{
    ...
    ///         IpamConfigs = new[]
    ///         {
    ///             new Scaleway.Vpc.Inputs.GatewayNetworkIpamConfigArgs
    ///             {
    ...
    /// 
    ///     var gw01 = new Scaleway.Vpc.PublicGatewayIP("gw01");
    /// 
    ...
    public partial class GatewayNetwork : global::Pulumi.CustomResource
    {
        ...
        public GatewayNetwork(string name, GatewayNetworkArgs args, CustomResourceOptions? options = null)
            : base("scaleway:vpc/gatewayNetwork:GatewayNetwork", name, args ?? new GatewayNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayNetwork(string name, Input<string> id, GatewayNetworkState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:vpc/gatewayNetwork:GatewayNetwork", name, state, MakeResourceOptions(options, id))
        {
        }

...
namespace Pulumi.Scaleway.Elasticmetal
{
    public static class GetFlexibleIP
    {
        ...
        public static Task<GetFlexibleIPResult> InvokeAsync(GetFlexibleIPArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFlexibleIPResult>("scaleway:elasticmetal/getFlexibleIP:getFlexibleIP", args ?? new GetFlexibleIPArgs(), options.WithDefaults());

        /// <summary>
        /// Gets information about a Flexible IP.
        /// </summary>
        public static Output<GetFlexibleIPResult> Invoke(GetFlexibleIPInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFlexibleIPResult>("scaleway:elasticmetal/getFlexibleIP:getFlexibleIP", args ?? new GetFlexibleIPInvokeArgs(), options.WithDefaults());
    }

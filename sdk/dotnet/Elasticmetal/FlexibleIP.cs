...
namespace Pulumi.Scaleway.Elasticmetal
{
    ...
    /// {
    ///     var main = new Scaleway.Elasticmetal.FlexibleIP("main", new()
    ///     {
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var mainSSHKey = new Scaleway.Account.SSHKey("mainSSHKey", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var mainFlexibleIP = new Scaleway.Elasticmetal.FlexibleIP("mainFlexibleIP", new()
    ///     {
    ///         ServerId = @base.Id,
    ///         Zone = "fr-par-2",
    ///     });
    ...
    public partial class FlexibleIP : global::Pulumi.CustomResource
    {
        ...
        public FlexibleIP(string name, FlexibleIPArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:elasticmetal/flexibleIP:FlexibleIP", name, args ?? new FlexibleIPArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FlexibleIP(string name, Input<string> id, FlexibleIPState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:elasticmetal/flexibleIP:FlexibleIP", name, state, MakeResourceOptions(options, id))
        {
        }

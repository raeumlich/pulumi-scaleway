...
namespace Pulumi.Scaleway.Webhosting
{
    ...
    ///     });
    /// 
    ///     var main = new Scaleway.Webhosting.WebHosting("main", new()
    ///     {
    ...
    public partial class WebHosting : global::Pulumi.CustomResource
    {
        ...
        public WebHosting(string name, WebHostingArgs args, CustomResourceOptions? options = null)
            : base("scaleway:webhosting/webHosting:WebHosting", name, args ?? new WebHostingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebHosting(string name, Input<string> id, WebHostingState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:webhosting/webHosting:WebHosting", name, state, MakeResourceOptions(options, id))
        {
        }

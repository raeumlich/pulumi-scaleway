...
namespace Pulumi.Scaleway.Iam
{
    ...
    /// 
    ///     var withApp = new Scaleway.Iam.Group("withApp", new()
    ///     {
    ///         ApplicationIds = new[]
    ///         {
    ///             app.Id,
    ...
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:iam/group:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, GroupState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:iam/group:Group", name, state, MakeResourceOptions(options, id))
        {
        }

...
namespace Pulumi.Scaleway.Rdb
{
    ...
    /// {
    ///     var main = new Scaleway.Rdb.Database("main", new()
    ///     {
    ...
    /// 
    /// ```sh
    ///  $ pulumi import scaleway:rdb/database:Database rdb01_mydb fr-par/11111111-1111-1111-1111-111111111111/mydb
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:rdb/database:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("scaleway:rdb/database:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, DatabaseState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:rdb/database:Database", name, state, MakeResourceOptions(options, id))
        {
        }

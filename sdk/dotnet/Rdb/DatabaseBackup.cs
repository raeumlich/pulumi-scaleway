...
namespace Pulumi.Scaleway.Rdb
{
    ...
    /// {
    ///     var main = new Scaleway.Rdb.DatabaseBackup("main", new()
    ///     {
    ...
    public partial class DatabaseBackup : global::Pulumi.CustomResource
    {
        ...
        public DatabaseBackup(string name, DatabaseBackupArgs args, CustomResourceOptions? options = null)
            : base("scaleway:rdb/databaseBackup:DatabaseBackup", name, args ?? new DatabaseBackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseBackup(string name, Input<string> id, DatabaseBackupState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:rdb/databaseBackup:DatabaseBackup", name, state, MakeResourceOptions(options, id))
        {
        }

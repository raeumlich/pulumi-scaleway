...
namespace Pulumi.Scaleway.Rdb
{
    ...
    /// {
    ///     var mainInstance = new Scaleway.Rdb.Instance("mainInstance", new()
    ///     {
    ///         NodeType = "DB-DEV-S",
    ...
    ///     });
    /// 
    ///     var mainDatabase = new Scaleway.Rdb.Database("mainDatabase", new()
    ///     {
    ///         InstanceId = mainInstance.Id,
    ///     });
    /// 
    ///     var mainUser = new Scaleway.Rdb.User("mainUser", new()
    ///     {
    ///         InstanceId = mainInstance.Id,
    ///         Password = "thiZ_is_v&amp;ry_s3cret",
    ///         IsAdmin = false,
    ...
    public partial class Privilege : global::Pulumi.CustomResource
    {
        ...
        public Privilege(string name, PrivilegeArgs args, CustomResourceOptions? options = null)
            : base("scaleway:rdb/privilege:Privilege", name, args ?? new PrivilegeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Privilege(string name, Input<string> id, PrivilegeState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:rdb/privilege:Privilege", name, state, MakeResourceOptions(options, id))
        {
        }

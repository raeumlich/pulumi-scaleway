...
namespace Pulumi.Scaleway.Tem
{
    ...
    ///     });
    /// 
    ///     var spf = new Scaleway.Dns.Record("spf", new()
    ///     {
    ///         DnsZone = domainName,
    ///         Type = "TXT",
    ...
    ///     });
    /// 
    ///     var dkim = new Scaleway.Dns.Record("dkim", new()
    ///     {
    ///         DnsZone = domainName,
    ///         Type = "TXT",
    ...
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("reputations")]
        public Output<ImmutableArray<Outputs.DomainReputation>> Reputations { get; private set; } = null!;
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("scaleway:tem/domain:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, DomainState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:tem/domain:Domain", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DomainState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("reputations")]
        private InputList<Inputs.DomainReputationGetArgs>? _reputations;

        /// <summary>
        /// The domain's reputation.
        /// </summary>
        public InputList<Inputs.DomainReputationGetArgs> Reputations
        {
            get => _reputations ?? (_reputations = new InputList<Inputs.DomainReputationGetArgs>());

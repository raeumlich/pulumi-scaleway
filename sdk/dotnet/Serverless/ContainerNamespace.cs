...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// 
    /// ```sh
    /// $ pulumi import scaleway:serverless/containerNamespace:ContainerNamespace main fr-par/11111111-1111-1111-1111-111111111111
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/containerNamespace:ContainerNamespace")]
    public partial class ContainerNamespace : global::Pulumi.CustomResource
    {
        ...
        public ContainerNamespace(string name, ContainerNamespaceArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerNamespace:ContainerNamespace", name, args ?? new ContainerNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ContainerNamespace(string name, Input<string> id, ContainerNamespaceState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerNamespace:ContainerNamespace", name, state, MakeResourceOptions(options, id))
        {
        }

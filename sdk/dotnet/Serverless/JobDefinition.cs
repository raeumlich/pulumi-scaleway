...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var main = new Scaleway.Serverless.JobDefinition("main", new()
    ///     {
    ///         CpuLimit = 140,
    ///         MemoryLimit = 256,
    ...
    public partial class JobDefinition : global::Pulumi.CustomResource
    {
        ...
        public JobDefinition(string name, JobDefinitionArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/jobDefinition:JobDefinition", name, args ?? new JobDefinitionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobDefinition(string name, Input<string> id, JobDefinitionState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/jobDefinition:JobDefinition", name, state, MakeResourceOptions(options, id))
        {
        }

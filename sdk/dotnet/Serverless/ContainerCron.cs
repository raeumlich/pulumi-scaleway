...
namespace Pulumi.Scaleway.Serverless
{
    ...
    ///     });
    /// 
    ///     var mainContainerCron = new Scaleway.Serverless.ContainerCron("mainContainerCron", new()
    ///     {
    ...
    public partial class ContainerCron : global::Pulumi.CustomResource
    {
        ...
        public ContainerCron(string name, ContainerCronArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerCron:ContainerCron", name, args ?? new ContainerCronArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerCron(string name, Input<string> id, ContainerCronState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerCron:ContainerCron", name, state, MakeResourceOptions(options, id))
        {
        }

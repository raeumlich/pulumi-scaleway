...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var main = new Scaleway.Serverless.FunctionNamespace("main", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/functionNamespace:FunctionNamespace")]
    public partial class FunctionNamespace : global::Pulumi.CustomResource
    {
        ...
        public FunctionNamespace(string name, FunctionNamespaceArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionNamespace:FunctionNamespace", name, args ?? new FunctionNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private FunctionNamespace(string name, Input<string> id, FunctionNamespaceState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionNamespace:FunctionNamespace", name, state, MakeResourceOptions(options, id))
        {
        }

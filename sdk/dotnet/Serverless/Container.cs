...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var mainContainerNamespace = new Scaleway.Serverless.ContainerNamespace("mainContainerNamespace", new()
    ///     {
    ...
    public partial class Container : global::Pulumi.CustomResource
    {
        ...
        public Container(string name, ContainerArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/container:Container", name, args ?? new ContainerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Container(string name, Input<string> id, ContainerState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/container:Container", name, state, MakeResourceOptions(options, id))
        {
        }

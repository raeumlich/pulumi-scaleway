...
namespace Pulumi.Scaleway.Serverless
{
    ...
    ///     });
    /// 
    ///     var mainFunctionDomain = new Scaleway.Serverless.FunctionDomain("mainFunctionDomain", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/functionDomain:FunctionDomain")]
    public partial class FunctionDomain : global::Pulumi.CustomResource
    {
        ...
        public FunctionDomain(string name, FunctionDomainArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionDomain:FunctionDomain", name, args ?? new FunctionDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionDomain(string name, Input<string> id, FunctionDomainState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionDomain:FunctionDomain", name, state, MakeResourceOptions(options, id))
        {
        }

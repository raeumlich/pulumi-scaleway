...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var main = new Scaleway.Serverless.FunctionTrigger("main", new()
    ///     {
    ///         FunctionId = scaleway_function.Main.Id,
    ///         Sqs = new Scaleway.Serverless.Inputs.FunctionTriggerSqsArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/functionTrigger:FunctionTrigger")]
    public partial class FunctionTrigger : global::Pulumi.CustomResource
    {
        ...
        public FunctionTrigger(string name, FunctionTriggerArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionTrigger:FunctionTrigger", name, args ?? new FunctionTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionTrigger(string name, Input<string> id, FunctionTriggerState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionTrigger:FunctionTrigger", name, state, MakeResourceOptions(options, id))
        {
        }

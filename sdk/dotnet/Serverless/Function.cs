...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var mainFunctionNamespace = new Scaleway.Serverless.FunctionNamespace("mainFunctionNamespace", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/function:Function")]
    public partial class Function : global::Pulumi.CustomResource
    {
        ...
        public Function(string name, FunctionArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/function:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, FunctionState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/function:Function", name, state, MakeResourceOptions(options, id))
        {
        }

...
namespace Pulumi.Scaleway.Serverless
{
    ...
    ///     });
    /// 
    ///     var mainFunctionCron = new Scaleway.Serverless.FunctionCron("mainFunctionCron", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var func = new Scaleway.Serverless.FunctionCron("func", new()
    ///     {
    ///         FunctionId = mainFunction.Id,
    ///         Schedule = "0 1 * * *",
    ///         Args = JsonSerializer.Serialize(new Dictionary&lt;string, object?&gt;
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/functionCron:FunctionCron")]
    public partial class FunctionCron : global::Pulumi.CustomResource
    {
        ...
        public FunctionCron(string name, FunctionCronArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionCron:FunctionCron", name, args ?? new FunctionCronArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionCron(string name, Input<string> id, FunctionCronState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionCron:FunctionCron", name, state, MakeResourceOptions(options, id))
        {
        }

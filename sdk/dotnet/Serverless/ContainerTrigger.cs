...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var main = new Scaleway.Serverless.ContainerTrigger("main", new()
    ///     {
    ///         ContainerId = scaleway_container.Main.Id,
    ///         Sqs = new Scaleway.Serverless.Inputs.ContainerTriggerSqsArgs
    ///         {
    ...
    ///     {
    ///         ContainerId = scaleway_container.Main.Id,
    ///         Nats = new Scaleway.Serverless.Inputs.ContainerTriggerNatsArgs
    ///         {
    ...
    public partial class ContainerTrigger : global::Pulumi.CustomResource
    {
        ...
        public ContainerTrigger(string name, ContainerTriggerArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerTrigger:ContainerTrigger", name, args ?? new ContainerTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerTrigger(string name, Input<string> id, ContainerTriggerState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerTrigger:ContainerTrigger", name, state, MakeResourceOptions(options, id))
        {
        }

...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var mainFunctionNamespace = new Scaleway.Serverless.FunctionNamespace("mainFunctionNamespace");
    /// 
    ///     var mainFunction = new Scaleway.Serverless.Function("mainFunction", new()
    ///     {
    ...
    /// 
    ///     // Namespace Token
    ///     var @namespace = new Scaleway.Serverless.FunctionToken("namespace", new()
    ///     {
    ///         NamespaceId = mainFunctionNamespace.Id,
    ...
    /// 
    ///     // Function Token
    ///     var function = new Scaleway.Serverless.FunctionToken("function", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/functionToken:FunctionToken")]
    public partial class FunctionToken : global::Pulumi.CustomResource
    {
        ...
        public FunctionToken(string name, FunctionTokenArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionToken:FunctionToken", name, args ?? new FunctionTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionToken(string name, Input<string> id, FunctionTokenState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/functionToken:FunctionToken", name, state, MakeResourceOptions(options, id))
        {
        }

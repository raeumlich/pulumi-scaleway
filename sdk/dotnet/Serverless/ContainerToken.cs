...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var mainContainerNamespace = new Scaleway.Serverless.ContainerNamespace("mainContainerNamespace");
    /// 
    ///     var mainContainer = new Scaleway.Serverless.Container("mainContainer", new()
    ///     {
    ///         NamespaceId = mainContainerNamespace.Id,
    ///     });
    /// 
    ///     // Namespace Token
    ///     var @namespace = new Scaleway.Serverless.ContainerToken("namespace", new()
    ///     {
    ///         NamespaceId = mainContainerNamespace.Id,
    ...
    /// 
    ///     // Container Token
    ///     var container = new Scaleway.Serverless.ContainerToken("container", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/containerToken:ContainerToken")]
    public partial class ContainerToken : global::Pulumi.CustomResource
    {
        ...
        public ContainerToken(string name, ContainerTokenArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerToken:ContainerToken", name, args ?? new ContainerTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerToken(string name, Input<string> id, ContainerTokenState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerToken:ContainerToken", name, state, MakeResourceOptions(options, id))
        {
        }

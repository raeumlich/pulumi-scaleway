...
namespace Pulumi.Scaleway.Serverless
{
    ...
    /// {
    ///     var appContainer = new Scaleway.Serverless.Container("appContainer");
    /// 
    ///     var appContainerDomain = new Scaleway.Serverless.ContainerDomain("appContainerDomain", new()
    ///     {
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var main = new Scaleway.Serverless.ContainerNamespace("main", new()
    ///     {
    ///         Description = "test container",
    ///     });
    /// 
    ///     var appContainer = new Scaleway.Serverless.Container("appContainer", new()
    ///     {
    ///         NamespaceId = main.Id,
    ...
    ///     });
    /// 
    ///     var appRecord = new Scaleway.Dns.Record("appRecord", new()
    ///     {
    ///         DnsZone = "domain.tld",
    ///         Type = "CNAME",
    ...
    /// 
    /// ```sh
    ///  $ pulumi import scaleway:serverless/containerDomain:ContainerDomain main fr-par/11111111-1111-1111-1111-111111111111
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:serverless/containerDomain:ContainerDomain")]
    public partial class ContainerDomain : global::Pulumi.CustomResource
    {
        ...
        public ContainerDomain(string name, ContainerDomainArgs args, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerDomain:ContainerDomain", name, args ?? new ContainerDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContainerDomain(string name, Input<string> id, ContainerDomainState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:serverless/containerDomain:ContainerDomain", name, state, MakeResourceOptions(options, id))
        {
        }

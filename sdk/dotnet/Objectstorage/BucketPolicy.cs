...
namespace Pulumi.Scaleway.Objectstorage
{
    ...
    ///     });
    /// 
    ///     var policyPolicy = new Scaleway.Iam.Policy("policyPolicy", new()
    ///     {
    ...
    /// 
    ///     var policyBucketPolicy = new Scaleway.Objectstorage.BucketPolicy("policyBucketPolicy", new()
    ///     {
    ///         Bucket = bucket.Name,
    ...
    /// 
    ///     // IAM configuration
    ///     var reading_app = new Scaleway.Iam.Application("reading-app");
    /// 
    ///     var policyPolicy = new Scaleway.Iam.Policy("policyPolicy", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var bucket = Scaleway.Objectstorage.GetBucket.Invoke(new()
    ///     {
    ...
    ///     });
    /// 
    ///     var main = new Scaleway.Objectstorage.BucketPolicy("main", new()
    ///     {
    ///         Bucket = bucket.Id,
    ...
    /// 
    ///     // Object storage configuration
    ///     var bucket = new Scaleway.Objectstorage.Bucket("bucket", new()
    ///     {
    ///         Region = "fr-par",
    ///     });
    /// 
    ///     var policy = new Scaleway.Objectstorage.BucketPolicy("policy", new()
    ///     {
    ///         Bucket = bucket.Name,
    ...
    ///                         ["Principal"] = new Dictionary&lt;string, object?&gt;
    ///                         {
    ///                             ["SCW"] = $"project_id:{@default.Apply(getProjectResult =&gt; getProjectResult.Id)}",
    ///                         },
    ///                         ["Resource"] = new[]
    ///                         {
    ///                             bucketName,
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:objectstorage/bucketPolicy:BucketPolicy")]
    public partial class BucketPolicy : global::Pulumi.CustomResource
    {
        ...
        public BucketPolicy(string name, BucketPolicyArgs args, CustomResourceOptions? options = null)
            : base("scaleway:objectstorage/bucketPolicy:BucketPolicy", name, args ?? new BucketPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BucketPolicy(string name, Input<string> id, BucketPolicyState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:objectstorage/bucketPolicy:BucketPolicy", name, state, MakeResourceOptions(options, id))
        {
        }

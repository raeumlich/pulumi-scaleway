...
namespace Pulumi.Scaleway.Objectstorage
{
    ...
    ///     });
    /// 
    ///     var mainBucketWebsiteConfiguration = new Scaleway.Objectstorage.BucketWebsiteConfiguration("mainBucketWebsiteConfiguration", new()
    ///     {
    ///         Bucket = mainBucket.Id,
    ///         IndexDocument = new Scaleway.Objectstorage.Inputs.BucketWebsiteConfigurationIndexDocumentArgs
    ///         {
    ///             Suffix = "index.html",
    ///         },
    ///     });
    ...
    ///     });
    /// 
    ///     var mainBucketPolicy = new Scaleway.Objectstorage.BucketPolicy("mainBucketPolicy", new()
    ///     {
    ///         Bucket = mainBucket.Id,
    ...
    public partial class BucketWebsiteConfiguration : global::Pulumi.CustomResource
    {
        ...
        public BucketWebsiteConfiguration(string name, BucketWebsiteConfigurationArgs args, CustomResourceOptions? options = null)
            : base("scaleway:objectstorage/bucketWebsiteConfiguration:BucketWebsiteConfiguration", name, args ?? new BucketWebsiteConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private BucketWebsiteConfiguration(string name, Input<string> id, BucketWebsiteConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:objectstorage/bucketWebsiteConfiguration:BucketWebsiteConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }

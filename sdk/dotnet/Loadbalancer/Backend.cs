...
namespace Pulumi.Scaleway.Loadbalancer
{
    ...
    /// {
    ///     var backend01 = new Scaleway.Loadbalancer.Backend("backend01", new()
    ///     {
    ...
    ///         ForwardProtocol = "http",
    ///         ForwardPort = 80,
    ///         HealthCheckHttp = new Scaleway.Loadbalancer.Inputs.BackendHealthCheckHttpArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [ScalewayResourceType("scaleway:loadbalancer/backend:Backend")]
    public partial class Backend : global::Pulumi.CustomResource
    {
        ...
        public Backend(string name, BackendArgs args, CustomResourceOptions? options = null)
            : base("scaleway:loadbalancer/backend:Backend", name, args ?? new BackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backend(string name, Input<string> id, BackendState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:loadbalancer/backend:Backend", name, state, MakeResourceOptions(options, id))
        {
        }

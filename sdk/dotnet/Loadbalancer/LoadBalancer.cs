...
namespace Pulumi.Scaleway.Loadbalancer
{
    ...
    /// {
    ///     var main = new Scaleway.Loadbalancer.IP("main", new()
    ///     {
    ///         Zone = "fr-par-1",
    ///     });
    /// 
    ///     var @base = new Scaleway.Loadbalancer.LoadBalancer("base", new()
    ///     {
    ///         IpId = main.Id,
    ///         Zone = main.Zone,
    ///         Type = "LB-S",
    ...
    /// ## IP ID
    /// 
    /// Since v1.15.0, `ip_id` is a required field. This means that now a separate `scaleway.loadbalancer.IP` is required.
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var main = new Scaleway.Loadbalancer.LoadBalancer("main", new()
    ///     {
    ///         Type = "LB-S",
    ///         Zone = "fr-par-1",
    ///     });
    ...
    /// </summary>
    [ScalewayResourceType("scaleway:loadbalancer/loadBalancer:LoadBalancer")]
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("scaleway:loadbalancer/loadBalancer:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, LoadBalancerState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:loadbalancer/loadBalancer:LoadBalancer", name, state, MakeResourceOptions(options, id))
        {
        }

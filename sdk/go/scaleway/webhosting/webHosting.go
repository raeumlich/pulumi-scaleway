...
func NewWebHosting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:webhosting/webHosting:WebHosting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWebHosting(ctx *pulumi.Context,
	...
	var resource WebHosting
	err := ctx.ReadResource("scaleway:webhosting/webHosting:WebHosting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

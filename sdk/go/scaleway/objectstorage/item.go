...
func NewItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.RegisterResource("scaleway:objectstorage/item:Item", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetItem(ctx *pulumi.Context,
	...
	var resource Item
	err := ctx.ReadResource("scaleway:objectstorage/item:Item", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

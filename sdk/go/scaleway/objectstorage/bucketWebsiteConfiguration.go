...
func NewBucketWebsiteConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:objectstorage/bucketWebsiteConfiguration:BucketWebsiteConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketWebsiteConfiguration(ctx *pulumi.Context,
	...
	var resource BucketWebsiteConfiguration
	err := ctx.ReadResource("scaleway:objectstorage/bucketWebsiteConfiguration:BucketWebsiteConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

...
func NewBucketLockConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:objectstorage/bucketLockConfiguration:BucketLockConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketLockConfiguration(ctx *pulumi.Context,
	...
	var resource BucketLockConfiguration
	err := ctx.ReadResource("scaleway:objectstorage/bucketLockConfiguration:BucketLockConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

...
func NewDatabaseBackup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:rdb/databaseBackup:DatabaseBackup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseBackup(ctx *pulumi.Context,
	...
	var resource DatabaseBackup
	err := ctx.ReadResource("scaleway:rdb/databaseBackup:DatabaseBackup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

...
func NewReadReplica(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:rdb/readReplica:ReadReplica", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadReplica(ctx *pulumi.Context,
	...
	var resource ReadReplica
	err := ctx.ReadResource("scaleway:rdb/readReplica:ReadReplica", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

...
func NewFrontend(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:loadbalancer/frontend:Frontend", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFrontend(ctx *pulumi.Context,
	...
	var resource Frontend
	err := ctx.ReadResource("scaleway:loadbalancer/frontend:Frontend", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

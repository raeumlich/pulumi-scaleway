...
func NewContainerToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/containerToken:ContainerToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerToken(ctx *pulumi.Context,
	...
	var resource ContainerToken
	err := ctx.ReadResource("scaleway:serverless/containerToken:ContainerToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

...
func NewFunctionNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/functionNamespace:FunctionNamespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionNamespace(ctx *pulumi.Context,
	...
	var resource FunctionNamespace
	err := ctx.ReadResource("scaleway:serverless/functionNamespace:FunctionNamespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

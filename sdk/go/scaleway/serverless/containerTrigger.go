...
func NewContainerTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/containerTrigger:ContainerTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerTrigger(ctx *pulumi.Context,
	...
	var resource ContainerTrigger
	err := ctx.ReadResource("scaleway:serverless/containerTrigger:ContainerTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

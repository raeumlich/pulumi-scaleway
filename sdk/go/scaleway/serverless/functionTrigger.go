...
func NewFunctionTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/functionTrigger:FunctionTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionTrigger(ctx *pulumi.Context,
	...
	var resource FunctionTrigger
	err := ctx.ReadResource("scaleway:serverless/functionTrigger:FunctionTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

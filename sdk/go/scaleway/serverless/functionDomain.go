...
func NewFunctionDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/functionDomain:FunctionDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionDomain(ctx *pulumi.Context,
	...
	var resource FunctionDomain
	err := ctx.ReadResource("scaleway:serverless/functionDomain:FunctionDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

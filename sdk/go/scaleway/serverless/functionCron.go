...
func NewFunctionCron(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/functionCron:FunctionCron", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionCron(ctx *pulumi.Context,
	...
	var resource FunctionCron
	err := ctx.ReadResource("scaleway:serverless/functionCron:FunctionCron", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

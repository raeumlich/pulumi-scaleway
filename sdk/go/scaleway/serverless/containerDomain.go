...
func NewContainerDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/containerDomain:ContainerDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerDomain(ctx *pulumi.Context,
	...
	var resource ContainerDomain
	err := ctx.ReadResource("scaleway:serverless/containerDomain:ContainerDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

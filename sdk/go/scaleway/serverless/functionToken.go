...
func NewFunctionToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/functionToken:FunctionToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunctionToken(ctx *pulumi.Context,
	...
	var resource FunctionToken
	err := ctx.ReadResource("scaleway:serverless/functionToken:FunctionToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

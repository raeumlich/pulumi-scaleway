...
func NewContainerNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:serverless/containerNamespace:ContainerNamespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerNamespace(ctx *pulumi.Context,
	...
	var resource ContainerNamespace
	err := ctx.ReadResource("scaleway:serverless/containerNamespace:ContainerNamespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

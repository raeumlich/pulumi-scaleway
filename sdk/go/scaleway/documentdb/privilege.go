...
func NewPrivilege(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("scaleway:documentdb/privilege:Privilege", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivilege(ctx *pulumi.Context,
	...
	var resource Privilege
	err := ctx.ReadResource("scaleway:documentdb/privilege:Privilege", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
